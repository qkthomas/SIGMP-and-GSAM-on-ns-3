...
#ifndef IPV4_STATIC_ROUTING_HELPER_MULTICAST_H
#define IPV4_STATIC_ROUTING_HELPER_MULTICAST_H
...
/**
 * \brief Helper class that adds ns3::Ipv4StaticRoutingMulticast objects
 *
 * This class is expected to be used in conjunction with 
 * ns3::InternetStackHelper::SetRoutingHelper
 */
class Ipv4StaticRoutingHelperMulticast : public Ipv4RoutingHelperMulticast
{
public:
  /*
   * Construct an Ipv4StaticRoutingHelperMulticast object, used to make configuration
   * of static routing easier.
   */
  Ipv4StaticRoutingHelperMulticast ();

  /**
   * \brief Construct an Ipv4StaticRoutingHelperMulticast from another previously 
   * initialized instance (Copy Constructor).
   */
  Ipv4StaticRoutingHelperMulticast (const Ipv4StaticRoutingHelperMulticast &);

  /**
   * \returns pointer to clone of this Ipv4StaticRoutingHelperMulticast
   *
   ...
   * Ipv4Multicast provided.
   *
   * \param ipv4 the Ptr<Ipv4Multicast> to search for the static routing protocol
   * \returns Ipv4StaticRoutingMulticast pointer or 0 if not found
   */
  Ptr<Ipv4StaticRoutingMulticast> GetStaticRouting (Ptr<Ipv4Multicast> ipv4) const;
...
private:
   ...
   * \returns
   */
  Ipv4StaticRoutingHelperMulticast &operator = (const Ipv4StaticRoutingHelperMulticast &);
};
