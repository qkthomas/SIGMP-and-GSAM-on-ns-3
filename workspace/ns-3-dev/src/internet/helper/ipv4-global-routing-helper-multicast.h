 ...
 */
#ifndef IPV4_GLOBAL_ROUTING_HELPER_MULTICAST_H
#define IPV4_GLOBAL_ROUTING_HELPER_MULTICAST_H
...
/**
 * \brief Helper class that adds ns3::Ipv4GlobalRoutingMulticast objects
 */
class Ipv4GlobalRoutingHelperMulticast  : public Ipv4RoutingHelperMulticast
{
public:
  /**
   ...
   */
  Ipv4GlobalRoutingHelperMulticast (const Ipv4GlobalRoutingHelperMulticast &);

  /**
   * \returns pointer to clone of this Ipv4GlobalRoutingHelperMulticast
   *
...
private:
   ...
   * \return
   */
  Ipv4GlobalRoutingHelperMulticast &operator = (const Ipv4GlobalRoutingHelperMulticast &);
};
