...
#ifndef IPV4_ADDRESS_HELPER_MULTICAST_H
#define IPV4_ADDRESS_HELPER_MULTICAST_H
 ...
 * global problem.  Ipv4AddressHelperMulticast is a simple class to make simple problems
 * easy to handle.
 *
 ...
 */
class Ipv4AddressHelperMulticast
{
public:
/**
 ...
 */
  Ipv4AddressHelperMulticast (Ipv4Address network, Ipv4Mask mask, 
 ...
 * @see NewNetwork
 */
  Ipv4InterfaceContainerMulticast Assign (const NetDeviceContainer &c);
