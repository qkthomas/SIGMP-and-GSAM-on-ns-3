...
#ifndef IPV4_END_POINT_H_MULTICAST
#define IPV4_END_POINT_H_MULTICAST
...
public:
   ...
   * \param port the port
   */
  Ipv4EndPointMulticast (Ipv4Address address, uint16_t port);
   ...
   */
  void SetRxCallback (Callback<void,Ptr<Packet>, Ipv4Header, uint16_t, Ptr<Ipv4InterfaceMulticast> > callback);
  /**
...
private:
   ...
   */
  Callback<void,Ptr<Packet>, Ipv4Header, uint16_t, Ptr<Ipv4InterfaceMulticast> > m_rxCallback;
...
#endif /* IPV4_END_POINT_H_MULTICAST */
