 ...
 */
#ifndef IPV4_MULTICAST_H
#define IPV4_MULTICAST_H
...
/**
 * \ingroup internet
 * \defgroup ipv4 Ipv4Multicast
 */
/**
 * \ingroup ipv4
 * \brief Access to the Ipv4Multicast forwarding table, interfaces, and configuration
 *
 * This class defines the API to manipulate the following aspects of
 * the Ipv4Multicast implementation:
 * -# set/get an Ipv4RoutingProtocolMulticast 
 * -# register a NetDevice for use by the Ipv4Multicast layer (basically, to
 * create Ipv4Multicast-related state such as addressing and neighbor cache that 
 * is associated with a NetDevice)
 * -# manipulate the status of the NetDevice from the Ipv4Multicast perspective, 
 * such as marking it as Up or Down, 
 * -# adding, deleting, and getting addresses associated to the Ipv4Multicast 
 * interfaces.
 * -# exporting Ipv4Multicast configuration attributes
 * 
 * Each NetDevice has conceptually a single Ipv4Multicast interface associated
 * with it (the corresponding structure in the Linux Ipv4Multicast implementation
 * is struct in_device).  Each interface may have one or more Ipv4Multicast
 * addresses associated with it.  Each Ipv4Multicast address may have different
 ...
 *
 * Ipv4Multicast attributes such as whether IP forwarding is enabled and disabled
 * are also stored in this class
 *
 * TO DO:  Add API to allow access to the Ipv4Multicast neighbor table
 *
 * \see Ipv4RoutingProtocolMulticast
 * \see Ipv4InterfaceAddress
 */
class Ipv4Multicast : public Object
{
public:
  /**
  ...
  Ipv4Multicast ();
  virtual ~Ipv4Multicast ();

  /**
   * \brief Register a new routing protocol to be used by this Ipv4Multicast stack
   *
   ...
   * 
   * \param routingProtocol smart pointer to Ipv4RoutingProtocolMulticast object
   */
  virtual void SetRoutingProtocol (Ptr<Ipv4RoutingProtocolMulticast> routingProtocol) = 0;

  /**
   * \brief Get the routing protocol to be used by this Ipv4Multicast stack
   * 
   * \returns smart pointer to Ipv4RoutingProtocolMulticast object, or null pointer if none
   */
  virtual Ptr<Ipv4RoutingProtocolMulticast> GetRoutingProtocol (void) const = 0;

  /**
   * \param device device to add to the list of Ipv4Multicast interfaces
   *        which can be used as output interfaces during packet forwarding.
   * \returns the index of the Ipv4Multicast interface added.
   *
   * Once a device has been added, it can never be removed: if you want
   * to disable it, you can invoke Ipv4Multicast::SetDown which will
   ...
   * \returns The interface number of the Ipv4Multicast interface with the given 
   ...
   *
   */
  virtual void Insert (Ptr<IpL4ProtocolMulticast> protocol) = 0;
   ...
   * \param iif The incoming Ipv4Multicast interface index
   ...
   *
   * If the Ipv4Multicast attribute WeakEsModel is true, the unicast address may
   * match any of the Ipv4Multicast addresses on any interface.  If the attribute is
   ...
   *  has an Ipv4Multicast address within the prefix specified by the input
  ...
  /**
   * \param interface The interface number of an Ipv4Multicast interface.
   * \returns The NetDevice associated with the Ipv4Multicast interface number.
   */
  virtual Ptr<NetDevice> GetNetDevice (uint32_t interface) = 0;

  /**
   * \param device The NetDevice for an Ipv4Interface
   * \returns The interface number of an Ipv4Multicast interface or -1 if not found.
   */
  virtual int32_t GetInterfaceForDevice (Ptr<const NetDevice> device) const = 0;

  /**
   * \param interface Interface number of an Ipv4Multicast interface
   * \param address Ipv4InterfaceAddress address to associate with the underlying Ipv4Multicast interface
  ...
  virtual bool RemoveAddress (uint32_t interface, uint32_t addressIndex) = 0;
   ...
   /**
   * \brief Remove the given address on named Ipv4Multicast interface
   *
   * \param interface Interface number of an Ipv4Multicast interface
  ...
  /**
   * \param interface Interface number of Ipv4Multicast interface
   * \returns the Maximum Transmission Unit (in bytes) associated
   *          to the underlying Ipv4Multicast interface
   */
   ...
   * considered valid during Ipv4Multicast forwarding.
   */
   ...
   * ignored during Ipv4Multicast forwarding.
   */
   ...
   */
  virtual Ptr<IpL4ProtocolMulticast> GetProtocol (int protocolNumber) const = 0;
...
private:
  // Indirect the Ipv4Multicast attributes through private pure virtual methods
