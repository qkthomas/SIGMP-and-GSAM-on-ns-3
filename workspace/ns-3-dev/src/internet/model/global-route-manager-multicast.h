...
#ifndef GLOBAL_ROUTE_MANAGER_MULTICAST_H
#define GLOBAL_ROUTE_MANAGER_MULTICAST_H
 ...
 */
class GlobalRouteManagerMulticast
{
public:
/**
 ...
 */
  GlobalRouteManagerMulticast (GlobalRouteManagerMulticast& srm);
 ...
 */
  GlobalRouteManagerMulticast& operator= (GlobalRouteManagerMulticast& srm);
};
