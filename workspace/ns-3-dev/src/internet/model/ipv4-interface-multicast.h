 ...
 */
#ifndef IPV4_INTERFACE_MULTICAST_H
#define IPV4_INTERFACE_MULTICAST_H
...
public:
  ...
  Ipv4InterfaceMulticast ();
  virtual ~Ipv4InterfaceMulticast();
   ...
   */
  void SetArpCache (Ptr<ArpCacheMulticast> arpCache);
   ...
   */
  Ptr<ArpCacheMulticast> GetArpCache () const;
