...
#ifndef ICMPV4_L4_PROTOCOL_MULTICAST_H
#define ICMPV4_L4_PROTOCOL_MULTICAST_H
...
class Icmpv4L4ProtocolMulticast : public IpL4ProtocolMulticast
{
public:
  /**
  ...
  Icmpv4L4ProtocolMulticast ();
  virtual ~Icmpv4L4ProtocolMulticast ();
