 ...
 */
class ArpL3ProtocolMulticast : public Object
{
public:
  /**
  ...
  ArpL3ProtocolMulticast ();
  virtual ~ArpL3ProtocolMulticast ();
   ...
   * \param interface the Ipv4InterfaceMulticast
   * \returns a smart pointer to the ARP cache
   */
  Ptr<ArpCacheMulticast> CreateCache (Ptr<NetDevice> device, Ptr<Ipv4InterfaceMulticast> interface);
...
private:
  typedef std::list<Ptr<ArpCacheMulticast> > CacheList; //!< container of the ARP caches
  /**
   ...
   * \param o
   */
  ArpL3ProtocolMulticast (const ArpL3ProtocolMulticast &o);
  /**
   * \brief Copy constructor
   *
   * Defined and unimplemented to avoid misuse
   ...
   * \returns
   */
  ArpL3ProtocolMulticast &operator = (const ArpL3ProtocolMulticast &o);
   ...
   */
  Ptr<ArpCacheMulticast> FindCache (Ptr<NetDevice> device);
   ...
   */
  void SendArpRequest (Ptr<const ArpCacheMulticast>cache, Ipv4Address to);
  /**
   ...
   */
  void SendArpReply (Ptr<const ArpCacheMulticast> cache, Ipv4Address myIp, Ipv4Address toIp, Address toMac);
