...
#ifndef IPV4_STATIC_ROUTING_MULTICAST_H
#define IPV4_STATIC_ROUTING_MULTICAST_H
...
/**
 * \ingroup internet
 * \defgroup ipv4StaticRouting Ipv4StaticRoutingMulticast
 */
/**
 ...
 * unicast and multicast routes into the Ipv4Multicast routing system.
 * This particular protocol is designed to be inserted into an 
 * Ipv4ListRouting protocol but can be used also as a standalone
 * protocol.
 * 
 * The Ipv4StaticRoutingMulticast class inherits from the abstract base class 
 * Ipv4RoutingProtocolMulticast that defines the interface methods that a routing 
 ...
 */
class Ipv4StaticRoutingMulticast : public Ipv4RoutingProtocolMulticast
{
public:
  /**
  ...
  Ipv4StaticRoutingMulticast ();
  virtual ~Ipv4StaticRoutingMulticast ();
  ...
  virtual void SetIpv4 (Ptr<Ipv4Multicast> ipv4);
 ...
 *
 * \see Ipv4Address
 * \see Ipv4StaticRoutingMulticast::Lookup
 */
 ...
 *
 * \see Ipv4RoutingTableEntry
 * \see Ipv4StaticRoutingMulticast::RemoveRoute
 */
 ...
 *
 * \see Ipv4RoutingTableEntry
 * \see Ipv4StaticRoutingMulticast::GetRoute
 * \see Ipv4StaticRoutingMulticast::AddRoute
 */
 ...
 * by the index Ipv4RoutingProtocolMulticast::INTERFACE_ANY.
 *
 ...
 * Ipv4RoutingProtocolMulticast::INTERFACE_ANY for packets of local origin.
 ...
 *
 * \see Ipv4MulticastRoutingTableEntry
 * \see Ipv4StaticRoutingMulticast::AddMulticastRoute
 */
...
private:
  ...
  /**
   * \brief Ipv4Multicast reference.
   */
  Ptr<Ipv4Multicast> m_ipv4;
};
