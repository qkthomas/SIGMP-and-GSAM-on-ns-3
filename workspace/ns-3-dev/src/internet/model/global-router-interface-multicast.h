...
#ifndef GLOBAL_ROUTER_INTERFACE_MULTICAST_H
#define GLOBAL_ROUTER_INTERFACE_MULTICAST_H
...
#include "ns3/global-route-manager-multicast.h"
#include "ns3/ipv4-routing-table-entry.h"

namespace ns3 {

class GlobalRouterMulticast;
class Ipv4GlobalRoutingMulticast;

/**
 * @brief A single link record for a link state advertisement.
 *
 * The GlobalRoutingLinkRecordMulticast is modeled after the OSPF link record field of
 ...
 */
class GlobalRoutingLinkRecordMulticast
{
public:
  friend class GlobalRoutingLSAMulticast;
/**
 * @enum LinkType
 ...
 *
 * The Link ID and Link Data Ipv4Multicast addresses are set to "0.0.0.0";
 ...
 */
class GlobalRoutingLSAMulticast
{
public:
/**
 * @enum LSType
 ...
 */
  GlobalRoutingLSAMulticast(SPFStatus status, Ipv4Address linkStateId, 
 ...
 */
  GlobalRoutingLSAMulticast (GlobalRoutingLSAMulticast& lsa);
 ...
 */
  void CopyLinkRecords (const GlobalRoutingLSAMulticast& lsa);
 ...
 */
  uint32_t AddLinkRecord (GlobalRoutingLinkRecordMulticast* lr);
 ...
 * @returns The number of link records in the list.
 */
  GlobalRoutingLinkRecordMulticast* GetLinkRecord (uint32_t n) const;
 ...
 */
  typedef std::list<GlobalRoutingLinkRecordMulticast*> ListOfLinkRecords_t;
 ...
 * if an SPFVertexMulticast (a data structure representing a vertex in the SPF tree
 ...
 */
class GlobalRouterMulticast : public Object
{
public:
  /**
 ...
 * @see GlobalRouterMulticast::GetLSA ()
 ...
 * State Advertisement into the requested GlobalRoutingLSAMulticast object.
 *
 * You must call GlobalRouterMulticast::GetNumLSAs before calling this method in 
 ...
 * @param lsa The GlobalRoutingLSAMulticast class to receive the LSA information.
 * @returns The number of Global Router Link State Advertisements.
 */
  bool GetLSA (uint32_t n, GlobalRoutingLSAMulticast &lsa) const;
 ...
 *
 * @see GlobalRouterMulticast::WithdrawRoute ()
 */
 ...
 *
 * @see GlobalRouterMulticast::RemoveInjectedRoute ()
 */
  bool WithdrawRoute (Ipv4Address network, Ipv4Mask networkMask);

private:
  virtual ~GlobalRouterMulticast ();
   ...
   */
  void ProcessBroadcastLink (Ptr<NetDevice> nd, GlobalRoutingLSAMulticast *pLSA, NetDeviceContainer &c);
   ...
   * \param c the returned NetDevice container
   */
  void ProcessSingleBroadcastLink (Ptr<NetDevice> nd, GlobalRoutingLSAMulticast *pLSA, NetDeviceContainer &c);
   ...
   * \param c the returned NetDevice container
   */
  void ProcessBridgedBroadcastLink (Ptr<NetDevice> nd, GlobalRoutingLSAMulticast *pLSA, NetDeviceContainer &c);
   ...
   * \param pLSA the Global LSA
   */
  void ProcessPointToPointLink (Ptr<NetDevice> ndLocal, GlobalRoutingLSAMulticast *pLSA);
  ...
  typedef std::list<GlobalRoutingLSAMulticast*> ListOfLSAs_t; //!< container for the GlobalRoutingLSAs
  ListOfLSAs_t m_LSAs; //!< database of GlobalRoutingLSAs

  Ipv4Address m_routerId; //!< router ID (its IPv4 address)
  Ptr<Ipv4GlobalRoutingMulticast> m_routingProtocol; //!< the Ipv4GlobalRoutingMulticast in use
 ...
 */
  GlobalRouterMulticast (GlobalRouterMulticast& sr);

/**
 * @brief Global Router assignment operator is disallowed.
 */
  GlobalRouterMulticast& operator= (GlobalRouterMulticast& sr);
};
