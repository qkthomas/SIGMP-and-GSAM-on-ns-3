...
#ifndef IPV4_L3_PROTOCOL_MULTICAST_H
#define IPV4_L3_PROTOCOL_MULTICAST_H
...
/**
 * \brief Implement the Ipv4Multicast layer.
 * 
 ...
 * attack.
 */
class Ipv4L3ProtocolMulticast : public Ipv4Multicast
{
public:
  /**
  ...
  Ipv4L3ProtocolMulticast();
  virtual ~Ipv4L3ProtocolMulticast ();
  ...
  // functions defined in base class Ipv4Multicast

  void SetRoutingProtocol (Ptr<Ipv4RoutingProtocolMulticast> routingProtocol);
  Ptr<Ipv4RoutingProtocolMulticast> GetRoutingProtocol (void) const;
   ...
   */
  void Insert (Ptr<IpL4ProtocolMulticast> protocol);
   ...
   * Insert (Ptr<IpL4ProtocolMulticast> protocol) method.
   *
   ...
   */
  void Insert (Ptr<IpL4ProtocolMulticast> protocol, uint32_t interfaceIndex);
   ...
   */
  virtual Ptr<IpL4ProtocolMulticast> GetProtocol (int protocolNumber) const;
   ...
   * \return corresponding IpL4ProtocolMulticast or 0 if not found
   */
  virtual Ptr<IpL4ProtocolMulticast> GetProtocol (int protocolNumber, int32_t interfaceIndex) const;
   ...
   */
  void Remove (Ptr<IpL4ProtocolMulticast> protocol);
   ...
   * \param interfaceIndex interface index.
   */
  void Remove (Ptr<IpL4ProtocolMulticast> protocol, uint32_t interfaceIndex);
   ...
   */
  Ptr<Ipv4InterfaceMulticast> GetInterface (uint32_t i) const;
   ...
   * \param [in] ipv4
   * \param [in] interface
   * \deprecated The non-const \c Ptr<Ipv4Multicast> argument is deprecated
   * and will be changed to \c Ptr<const Ipv4Multicast> in a future release.
   */
  typedef void (* TxRxTracedCallback)
    (Ptr<const Packet> packet, Ptr<Ipv4Multicast> ipv4, uint32_t interface);
  ...
  typedef void (* DropTracedCallback)
    (const Ipv4Header & header, Ptr<const Packet> packet,
     DropReason reason, Ptr<Ipv4Multicast> ipv4,
     uint32_t interface);
...
private:
   ...
   */
  Ipv4L3ProtocolMulticast(const Ipv4L3ProtocolMulticast &);
   ...
   */
  Ipv4L3ProtocolMulticast &operator = (const Ipv4L3ProtocolMulticast &);

  // class Ipv4Multicast attributes
   ...
   */
  uint32_t AddIpv4Interface (Ptr<Ipv4InterfaceMulticast> interface);
   ...
   */
  typedef std::vector<Ptr<Ipv4InterfaceMulticast> > Ipv4InterfaceList;
  /**
   * \brief Container of the IPv4 Raw Sockets.
   */
  typedef std::list<Ptr<Ipv4RawSocketImplMulticast> > SocketList;
   ...
   */
  typedef std::map<L4ListKey_t, Ptr<IpL4ProtocolMulticast> > L4List_t;
  ...
  /// \deprecated The non-const \c Ptr<Ipv4Multicast> argument is deprecated
  /// and will be changed to \c Ptr<const Ipv4Multicast> in a future release.
  TracedCallback<Ptr<const Packet>, Ptr<Ipv4Multicast>,  uint32_t> m_txTrace;
  /// Trace of received packets
  /// \deprecated The non-const \c Ptr<Ipv4Multicast> argument is deprecated
  /// and will be changed to \c Ptr<const Ipv4Multicast> in a future release.
  TracedCallback<Ptr<const Packet>, Ptr<Ipv4Multicast>, uint32_t> m_rxTrace;
  // <ip-header, payload, reason, ifindex> (ifindex not valid if reason is DROP_NO_ROUTE)
  /// Trace of dropped packets
  /// \deprecated The non-const \c Ptr<Ipv4Multicast> argument is deprecated
  /// and will be changed to \c Ptr<const Ipv4Multicast> in a future release.
  TracedCallback<const Ipv4Header &, Ptr<const Packet>, DropReason, Ptr<Ipv4Multicast>, uint32_t> m_dropTrace;

  Ptr<Ipv4RoutingProtocolMulticast> m_routingProtocol; //!< Routing protocol associated with the stack
