...
#ifndef IPV4_LIST_ROUTING_MULTICAST_H
#define IPV4_LIST_ROUTING_MULTICAST_H
...
/**
 * \ingroup internet 
 * \defgroup ipv4ListRouting Ipv4Multicast List Routing
 */
/**
 * \ingroup ipv4ListRouting
 *
 * This class is a specialization of Ipv4RoutingProtocolMulticast that allows 
 * other instances of Ipv4RoutingProtocolMulticast to be inserted in a 
 ...
 * 
 */
class Ipv4ListRoutingMulticast : public Ipv4RoutingProtocolMulticast
{
public:
  /**
  ...
  Ipv4ListRoutingMulticast ();
  virtual ~Ipv4ListRoutingMulticast ();
   ...
   */
  virtual void AddRoutingProtocol (Ptr<Ipv4RoutingProtocolMulticast> routingProtocol, int16_t priority);
  /**
   ...
   * \param priority output parameter, set to the priority of the protocol
            being returned
   */
  virtual Ptr<Ipv4RoutingProtocolMulticast> GetRoutingProtocol (uint32_t index, int16_t& priority) const;

  // Below are from Ipv4RoutingProtocolMulticast
...
private:
   ...
   */
  typedef std::pair<int16_t, Ptr<Ipv4RoutingProtocolMulticast> > Ipv4RoutingProtocolEntry;
  /**
  ...
  Ptr<Ipv4Multicast> m_ipv4; //!< Ipv4Multicast this protocol is associated with.
