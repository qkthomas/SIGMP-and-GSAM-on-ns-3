 ...
 */
class UdpSocketFactoryImplMulticast : public UdpSocketFactory
{
public:
  UdpSocketFactoryImplMulticast ();
  virtual ~UdpSocketFactoryImplMulticast ();

  /**
   * \brief Set the associated UDP L4 protocol.
   * \param udp the UDP L4 protocol
   */
  void SetUdp (Ptr<UdpL4ProtocolMulticast> udp);
