...
NS_LOG_COMPONENT_DEFINE ("UdpSocketImplMulticast");

NS_OBJECT_ENSURE_REGISTERED (UdpSocketImplMulticast);
...
TypeId
UdpSocketImplMulticast::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::UdpSocketImplMulticast")
    .SetParent<UdpSocket> ()
    .SetGroupName ("Internet")
    .AddConstructor<UdpSocketImplMulticast> ()
    .AddTraceSource ("Drop",
                     "Drop UDP packet due to receive buffer overflow",
                     MakeTraceSourceAccessor (&UdpSocketImplMulticast::m_dropTrace),
                     "ns3::Packet::TracedCallback")
    .AddAttribute ("IcmpCallback", "Callback invoked whenever an icmp error is received on this socket.",
                   CallbackValue (),
                   MakeCallbackAccessor (&UdpSocketImplMulticast::m_icmpCallback),
                   MakeCallbackChecker ())
    .AddAttribute ("IcmpCallback6", "Callback invoked whenever an icmpv6 error is received on this socket.",
                   CallbackValue (),
                   MakeCallbackAccessor (&UdpSocketImplMulticast::m_icmpCallback6),
                   MakeCallbackChecker ())
  ;
  return tid;
}

UdpSocketImplMulticast::UdpSocketImplMulticast ()
  : m_endPoint (0),
    m_endPoint6 (0),
    m_node (0),
    m_udp (0),
...
UdpSocketImplMulticast::~UdpSocketImplMulticast ()
{
   ...
   * UdpSocketImplMulticast::Destroy or UdpSocketImplMulticast::Destroy6
...
void 
UdpSocketImplMulticast::SetNode (Ptr<Node> node)
{
  NS_LOG_FUNCTION_NOARGS ();
  m_node = node;
...
void 
UdpSocketImplMulticast::SetUdp (Ptr<UdpL4ProtocolMulticast> udp)
{
  NS_LOG_FUNCTION_NOARGS ();
  m_udp = udp;
}
...
UdpSocketImplMulticast::GetErrno (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_errno;
}
...
UdpSocketImplMulticast::GetSocketType (void) const
{
  return NS3_SOCK_DGRAM;
}

Ptr<Node>
UdpSocketImplMulticast::GetNode (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_node;
}
...
void 
UdpSocketImplMulticast::Destroy (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  m_endPoint = 0;
}
...
void
UdpSocketImplMulticast::Destroy6 (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  m_endPoint6 = 0;
}
...
void
UdpSocketImplMulticast::DeallocateEndPoint (void)
{
  if (m_endPoint != 0)
    {
...
int
UdpSocketImplMulticast::FinishBind (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  bool done = false;
  if (m_endPoint != 0)
    {
      m_endPoint->SetRxCallback (MakeCallback (&UdpSocketImplMulticast::ForwardUp, Ptr<UdpSocketImplMulticast> (this)));
      m_endPoint->SetIcmpCallback (MakeCallback (&UdpSocketImplMulticast::ForwardIcmp, Ptr<UdpSocketImplMulticast> (this)));
      m_endPoint->SetDestroyCallback (MakeCallback (&UdpSocketImplMulticast::Destroy, Ptr<UdpSocketImplMulticast> (this)));
      done = true;
    }
  if (m_endPoint6 != 0)
    {
      m_endPoint6->SetRxCallback (MakeCallback (&UdpSocketImplMulticast::ForwardUp6, Ptr<UdpSocketImplMulticast> (this)));
      m_endPoint6->SetIcmpCallback (MakeCallback (&UdpSocketImplMulticast::ForwardIcmp6, Ptr<UdpSocketImplMulticast> (this)));
      m_endPoint6->SetDestroyCallback (MakeCallback (&UdpSocketImplMulticast::Destroy6, Ptr<UdpSocketImplMulticast> (this)));
      done = true;
    }
  if (done)
    {
...
int
UdpSocketImplMulticast::Bind (void)
{
  NS_LOG_FUNCTION_NOARGS ();
...
int
UdpSocketImplMulticast::Bind6 (void)
{
  NS_LOG_FUNCTION_NOARGS ();
...
int 
UdpSocketImplMulticast::Bind (const Address &address)
{
...
int 
UdpSocketImplMulticast::ShutdownSend (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  m_shutdownSend = true;
  return 0;
...
int 
UdpSocketImplMulticast::ShutdownRecv (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  m_shutdownRecv = true;
  if (m_endPoint)
...
int
UdpSocketImplMulticast::Close (void)
{
  NS_LOG_FUNCTION_NOARGS ();
...
int
UdpSocketImplMulticast::Connect (const Address & address)
{
  NS_LOG_FUNCTION (this << address);
...
int 
UdpSocketImplMulticast::Listen (void)
{
...
int 
UdpSocketImplMulticast::Send (Ptr<Packet> p, uint32_t flags)
{
...
int 
UdpSocketImplMulticast::DoSend (Ptr<Packet> p)
{
...
int
UdpSocketImplMulticast::DoSendTo (Ptr<Packet> p, Ipv4Address dest, uint16_t port)
{
  ...
  if (dest.IsBroadcast ())
  ...
  else if (ipv4->GetRoutingProtocol () != 0)
    {
      ...
      header.SetProtocol (UdpL4ProtocolMulticast::PROT_NUMBER);
...
int
UdpSocketImplMulticast::DoSendTo (Ptr<Packet> p, Ipv6Address dest, uint16_t port)
{
  NS_LOG_FUNCTION (this << p << dest << port);
...
uint32_t
UdpSocketImplMulticast::GetTxAvailable (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
...
int 
UdpSocketImplMulticast::SendTo (Ptr<Packet> p, uint32_t flags, const Address &address)
{
...
uint32_t
UdpSocketImplMulticast::GetRxAvailable (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
...
Ptr<Packet>
UdpSocketImplMulticast::Recv (uint32_t maxSize, uint32_t flags)
{
...
Ptr<Packet>
UdpSocketImplMulticast::RecvFrom (uint32_t maxSize, uint32_t flags, 
                         Address &fromAddress)
{
  NS_LOG_FUNCTION (this << maxSize << flags);
...
int
UdpSocketImplMulticast::GetSockName (Address &address) const
{
  NS_LOG_FUNCTION_NOARGS ();
  if (m_endPoint != 0)
    {
...
int
UdpSocketImplMulticast::GetPeerName (Address &address) const
{
  NS_LOG_FUNCTION (this << address);
...
int 
UdpSocketImplMulticast::MulticastJoinGroup (uint32_t interface, const Address &groupAddress)
{
...
int 
UdpSocketImplMulticast::MulticastLeaveGroup (uint32_t interface, const Address &groupAddress) 
{
  NS_LOG_FUNCTION (interface << groupAddress);
  /*
   1) sanity check interface
...
void
UdpSocketImplMulticast::BindToNetDevice (Ptr<NetDevice> netdevice)
{
...
void 
UdpSocketImplMulticast::ForwardUp6 (Ptr<Packet> packet, Ipv6Header header, uint16_t port, Ptr<Ipv6Interface> incomingInterface)
{
...
void
UdpSocketImplMulticast::ForwardIcmp (Ipv4Address icmpSource, uint8_t icmpTtl, 
...
void
UdpSocketImplMulticast::ForwardIcmp6 (Ipv6Address icmpSource, uint8_t icmpTtl, 
                            uint8_t icmpType, uint8_t icmpCode,
                            uint32_t icmpInfo)
{
  NS_LOG_FUNCTION (this << icmpSource << (uint32_t)icmpTtl << (uint32_t)icmpType <<
...
void 
UdpSocketImplMulticast::SetRcvBufSize (uint32_t size)
{
  m_rcvBufSize = size;
}

uint32_t 
UdpSocketImplMulticast::GetRcvBufSize (void) const
{
  return m_rcvBufSize;
}

void 
UdpSocketImplMulticast::SetIpMulticastTtl (uint8_t ipTtl)
{
  m_ipMulticastTtl = ipTtl;
}

uint8_t 
UdpSocketImplMulticast::GetIpMulticastTtl (void) const
{
  return m_ipMulticastTtl;
}

void 
UdpSocketImplMulticast::SetIpMulticastIf (int32_t ipIf)
{
  m_ipMulticastIf = ipIf;
}

int32_t 
UdpSocketImplMulticast::GetIpMulticastIf (void) const
{
  return m_ipMulticastIf;
}

void 
UdpSocketImplMulticast::SetIpMulticastLoop (bool loop)
{
  m_ipMulticastLoop = loop;
}

bool 
UdpSocketImplMulticast::GetIpMulticastLoop (void) const
{
  return m_ipMulticastLoop;
}

void 
UdpSocketImplMulticast::SetMtuDiscover (bool discover)
{
  m_mtuDiscover = discover;
}
bool 
UdpSocketImplMulticast::GetMtuDiscover (void) const
{
  return m_mtuDiscover;
}

bool
UdpSocketImplMulticast::SetAllowBroadcast (bool allowBroadcast)
{
...
bool
UdpSocketImplMulticast::GetAllowBroadcast () const
{
  return m_allowBroadcast;
}

void
UdpSocketImplMulticast::Ipv6JoinGroup (Ipv6Address address, Socket::Ipv6MulticastFilterMode filterMode, std::vector<Ipv6Address> sourceAddresses)
{
