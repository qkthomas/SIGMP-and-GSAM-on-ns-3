...
#include "ipv4-static-routing-multicast.h"
...
NS_LOG_COMPONENT_DEFINE ("Ipv4StaticRoutingMulticast");

NS_OBJECT_ENSURE_REGISTERED (Ipv4StaticRoutingMulticast);

TypeId
Ipv4StaticRoutingMulticast::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::Ipv4StaticRoutingMulticast")
    .SetParent<Ipv4RoutingProtocolMulticast> ()
    .SetGroupName ("Internet")
    .AddConstructor<Ipv4StaticRoutingMulticast> ()
  ;
  return tid;
}

Ipv4StaticRoutingMulticast::Ipv4StaticRoutingMulticast () 
  : m_ipv4 (0)
{
...
void 
Ipv4StaticRoutingMulticast::AddNetworkRouteTo (Ipv4Address network, 
...
void 
Ipv4StaticRoutingMulticast::AddHostRouteTo (Ipv4Address dest, 
                                   Ipv4Address nextHop,
                                   uint32_t interface,
                                   uint32_t metric)
{
...
void 
Ipv4StaticRoutingMulticast::SetDefaultRoute (Ipv4Address nextHop, 
                                    uint32_t interface,
                                    uint32_t metric)
{
...
void 
Ipv4StaticRoutingMulticast::AddMulticastRoute (Ipv4Address origin,
                                      Ipv4Address group,
...
void 
Ipv4StaticRoutingMulticast::SetDefaultMulticastRoute (uint32_t outputInterface)
{
...
uint32_t 
Ipv4StaticRoutingMulticast::GetNMulticastRoutes (void) const
{
  NS_LOG_FUNCTION (this);
...
Ipv4StaticRoutingMulticast::GetMulticastRoute (uint32_t index) const
{
  NS_LOG_FUNCTION (this << index);
  NS_ASSERT_MSG (index < m_multicastRoutes.size (),
                 "Ipv4StaticRoutingMulticast::GetMulticastRoute ():  Index out of range");
...
bool
Ipv4StaticRoutingMulticast::RemoveMulticastRoute (Ipv4Address origin,
                                         Ipv4Address group,
                                         uint32_t inputInterface)
{
...
void 
Ipv4StaticRoutingMulticast::RemoveMulticastRoute (uint32_t index)
{
  NS_LOG_FUNCTION (this << index);
  uint32_t tmp = 0;
  for (MulticastRoutesI i = m_multicastRoutes.begin (); 
...
Ptr<Ipv4Route>
Ipv4StaticRoutingMulticast::LookupStatic (Ipv4Address dest, Ptr<NetDevice> oif)
{
...
Ipv4StaticRoutingMulticast::LookupStatic (
  Ipv4Address origin, 
  Ipv4Address group,
  uint32_t    interface)
{
...
//
      ...
      if (group == route->GetGroup ())
        {
          if (interface == Ipv4Multicast::IF_ANY || 
...
uint32_t 
Ipv4StaticRoutingMulticast::GetNRoutes (void) const
{
  NS_LOG_FUNCTION (this);
...
Ipv4StaticRoutingMulticast::GetDefaultRoute ()
{
  NS_LOG_FUNCTION (this);
...
Ipv4RoutingTableEntry 
Ipv4StaticRoutingMulticast::GetRoute (uint32_t index) const
{
  NS_LOG_FUNCTION (this << index);
  uint32_t tmp = 0;
...
uint32_t
Ipv4StaticRoutingMulticast::GetMetric (uint32_t index) const
{
  NS_LOG_FUNCTION (this << index);
  uint32_t tmp = 0;
  for (NetworkRoutesCI j = m_networkRoutes.begin ();
...
void 
Ipv4StaticRoutingMulticast::RemoveRoute (uint32_t index)
{
  NS_LOG_FUNCTION (this << index);
  uint32_t tmp = 0;
...
Ptr<Ipv4Route> 
Ipv4StaticRoutingMulticast::RouteOutput (Ptr<Packet> p, const Ipv4Header &header, Ptr<NetDevice> oif, Socket::SocketErrno &sockerr)
{
...
bool 
Ipv4StaticRoutingMulticast::RouteInput  (Ptr<const Packet> p, const Ipv4Header &ipHeader, Ptr<const NetDevice> idev,
...
void
Ipv4StaticRoutingMulticast::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
  for (NetworkRoutesI j = m_networkRoutes.begin (); 
       j != m_networkRoutes.end (); 
  ...
  m_ipv4 = 0;
  Ipv4RoutingProtocolMulticast::DoDispose ();
}

void 
Ipv4StaticRoutingMulticast::NotifyInterfaceUp (uint32_t i)
{
...
void 
Ipv4StaticRoutingMulticast::NotifyInterfaceDown (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
...
void 
Ipv4StaticRoutingMulticast::NotifyAddAddress (uint32_t interface, Ipv4InterfaceAddress address)
{
...
void 
Ipv4StaticRoutingMulticast::NotifyRemoveAddress (uint32_t interface, Ipv4InterfaceAddress address)
{
  NS_LOG_FUNCTION (this << interface << " " << address.GetLocal ());
  if (!m_ipv4->IsUp (interface))
    {
...
void 
Ipv4StaticRoutingMulticast::SetIpv4 (Ptr<Ipv4Multicast> ipv4)
{
...
void
Ipv4StaticRoutingMulticast::PrintRoutingTable (Ptr<OutputStreamWrapper> stream) const
{
  ...
  *os << "Node: " << m_ipv4->GetObject<Node> ()->GetId ()
      ...
      << ", Ipv4StaticRoutingMulticast table" << std::endl;
...
Ipv4Address
Ipv4StaticRoutingMulticast::SourceAddressSelection (uint32_t interfaceIdx, Ipv4Address dest)
{
