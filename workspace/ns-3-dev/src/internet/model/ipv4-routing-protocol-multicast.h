 ...
 */
#ifndef IPV4_ROUTING_PROTOCOL_MULTICAST_H
#define IPV4_ROUTING_PROTOCOL_MULTICAST_H
...
/**
 * \ingroup internet 
 * \defgroup ipv4Routing Ipv4RoutingProtocolMulticast 
 */
/**
 * \ingroup ipv4Routing
 ...
 *
 */
class Ipv4RoutingProtocolMulticast : public Object
{
public:
  /**
   ...
   * handed over to the Ipv4RoutingProtocolMulticast, and will get forwarded onward
   ...
   * \returns true if the Ipv4RoutingProtocolMulticast takes responsibility for 
   ...
   * 
   * Typically, invoked directly or indirectly from ns3::Ipv4Multicast::SetRoutingProtocol
   */
  virtual void SetIpv4 (Ptr<Ipv4Multicast> ipv4) = 0;
