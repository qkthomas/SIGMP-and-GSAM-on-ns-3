...
NS_LOG_COMPONENT_DEFINE ("Ipv4L3ProtocolMulticast");

const uint16_t Ipv4L3ProtocolMulticast::PROT_NUMBER = 0x0800;

NS_OBJECT_ENSURE_REGISTERED (Ipv4L3ProtocolMulticast);

TypeId 
Ipv4L3ProtocolMulticast::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::Ipv4L3ProtocolMulticast")
    .SetParent<Ipv4Multicast> ()
    .SetGroupName ("Internet")
    .AddConstructor<Ipv4L3ProtocolMulticast> ()
    .AddAttribute ("DefaultTos",
                   "The TOS value set by default on "
                   "all outgoing packets generated on this node.",
                   UintegerValue (0),
                   MakeUintegerAccessor (&Ipv4L3ProtocolMulticast::m_defaultTos),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("DefaultTtl",
                   "The TTL value set by default on "
                   "all outgoing packets generated on this node.",
                   UintegerValue (64),
                   MakeUintegerAccessor (&Ipv4L3ProtocolMulticast::m_defaultTtl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("FragmentExpirationTimeout",
                   "When this timeout expires, the fragments "
                   "will be cleared from the buffer.",
                   TimeValue (Seconds (30)),
                   MakeTimeAccessor (&Ipv4L3ProtocolMulticast::m_fragmentExpirationTimeout),
                   MakeTimeChecker ())
    .AddTraceSource ("Tx",
                     "Send ipv4 packet to outgoing interface.",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolMulticast::m_txTrace),
                     "ns3::Ipv4L3ProtocolMulticast::TxRxTracedCallback")
    .AddTraceSource ("Rx",
                     "Receive ipv4 packet from incoming interface.",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolMulticast::m_rxTrace),
                     "ns3::Ipv4L3ProtocolMulticast::TxRxTracedCallback")
    .AddTraceSource ("Drop",
                     "Drop ipv4 packet",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolMulticast::m_dropTrace),
                     "ns3::Ipv4L3ProtocolMulticast::DropTracedCallback")
    .AddAttribute ("InterfaceList",
                   "The set of Ipv4Multicast interfaces associated to this Ipv4Multicast stack.",
                   ObjectVectorValue (),
                   MakeObjectVectorAccessor (&Ipv4L3ProtocolMulticast::m_interfaces),
                   MakeObjectVectorChecker<Ipv4InterfaceMulticast> ())

    .AddTraceSource ("SendOutgoing",
                     "A newly-generated packet by this node is "
                     "about to be queued for transmission",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolMulticast::m_sendOutgoingTrace),
                     "ns3::Ipv4L3ProtocolMulticast::SentTracedCallback")
    .AddTraceSource ("UnicastForward",
                     "A unicast IPv4 packet was received by this node "
                     "and is being forwarded to another node",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolMulticast::m_unicastForwardTrace),
                     "ns3::Ipv4L3ProtocolMulticast::SentTracedCallback")
    .AddTraceSource ("LocalDeliver",
                     "An IPv4 packet was received by/for this node, "
                     "and it is being forward up the stack",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolMulticast::m_localDeliverTrace),
                     "ns3::Ipv4L3ProtocolMulticast::SentTracedCallback")
...
Ipv4L3ProtocolMulticast::Ipv4L3ProtocolMulticast()
{
...
void
Ipv4L3ProtocolMulticast::Insert (Ptr<IpL4ProtocolMulticast> protocol)
{
...
void
Ipv4L3ProtocolMulticast::Insert (Ptr<IpL4ProtocolMulticast> protocol, uint32_t interfaceIndex)
{
...
void
Ipv4L3ProtocolMulticast::Remove (Ptr<IpL4ProtocolMulticast> protocol)
{
  NS_LOG_FUNCTION (this << protocol);
...
void
Ipv4L3ProtocolMulticast::Remove (Ptr<IpL4ProtocolMulticast> protocol, uint32_t interfaceIndex)
{
  NS_LOG_FUNCTION (this << protocol << interfaceIndex);
...
Ptr<IpL4ProtocolMulticast>
Ipv4L3ProtocolMulticast::GetProtocol (int protocolNumber) const
{
...
Ptr<IpL4ProtocolMulticast>
Ipv4L3ProtocolMulticast::GetProtocol (int protocolNumber, int32_t interfaceIndex) const
{
...
void
Ipv4L3ProtocolMulticast::SetNode (Ptr<Node> node)
{
  NS_LOG_FUNCTION (this << node);
  m_node = node;
  // Add a LoopbackNetDevice if needed, and an Ipv4InterfaceMulticast on top of it
  SetupLoopback ();
}

Ptr<Socket> 
Ipv4L3ProtocolMulticast::CreateRawSocket (void)
{
  NS_LOG_FUNCTION (this);
  Ptr<Ipv4RawSocketImplMulticast> socket = CreateObject<Ipv4RawSocketImplMulticast> ();
  socket->SetNode (m_node);
  m_sockets.push_back (socket);
  return socket;
}
void 
Ipv4L3ProtocolMulticast::DeleteRawSocket (Ptr<Socket> socket)
{
 ...
 */
void
Ipv4L3ProtocolMulticast::NotifyNewAggregate ()
{
  NS_LOG_FUNCTION (this);
  if (m_node == 0)
    {
  ...
  Ipv4Multicast::NotifyNewAggregate ();
}

void 
Ipv4L3ProtocolMulticast::SetRoutingProtocol (Ptr<Ipv4RoutingProtocolMulticast> routingProtocol)
{
...
Ipv4L3ProtocolMulticast::GetRoutingProtocol (void) const
{
  NS_LOG_FUNCTION (this);
...
void 
Ipv4L3ProtocolMulticast::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4L3ProtocolMulticast::SetupLoopback (void)
{
  NS_LOG_FUNCTION (this);

  Ptr<Ipv4InterfaceMulticast> interface = CreateObject<Ipv4InterfaceMulticast> ();
  ...
  node->RegisterProtocolHandler (MakeCallback (&Ipv4L3ProtocolMulticast::Receive, this), 
                                 Ipv4L3ProtocolMulticast::PROT_NUMBER, device);
  interface->SetUp ();
...
void 
Ipv4L3ProtocolMulticast::SetDefaultTtl (uint8_t ttl)
{
...
uint32_t 
Ipv4L3ProtocolMulticast::AddInterface (Ptr<NetDevice> device)
{
  ...
  node->RegisterProtocolHandler (MakeCallback (&Ipv4L3ProtocolMulticast::Receive, this), 
                                 Ipv4L3ProtocolMulticast::PROT_NUMBER, device);
  node->RegisterProtocolHandler (MakeCallback (&ArpL3ProtocolMulticast::Receive, PeekPointer (GetObject<ArpL3ProtocolMulticast> ())),
                                 ArpL3ProtocolMulticast::PROT_NUMBER, device);
...
uint32_t 
Ipv4L3ProtocolMulticast::AddIpv4Interface (Ptr<Ipv4InterfaceMulticast>interface)
{
...
Ipv4L3ProtocolMulticast::GetInterface (uint32_t index) const
{
...
uint32_t 
Ipv4L3ProtocolMulticast::GetNInterfaces (void) const
{
  NS_LOG_FUNCTION (this);
...
int32_t 
Ipv4L3ProtocolMulticast::GetInterfaceForAddress (
...
int32_t 
Ipv4L3ProtocolMulticast::GetInterfaceForPrefix (
  Ipv4Address address, 
  Ipv4Mask mask) const
{
...
int32_t 
Ipv4L3ProtocolMulticast::GetInterfaceForDevice (
...
bool
Ipv4L3ProtocolMulticast::IsDestinationAddress (Ipv4Address address, uint32_t iif) const
{
...
void 
Ipv4L3ProtocolMulticast::Receive ( Ptr<NetDevice> device, Ptr<const Packet> p, uint16_t protocol, const Address &from,
                          const Address &to, NetDevice::PacketType packetType)
{
  ...
  Ptr<Ipv4InterfaceMulticast> ipv4Interface;
  for (Ipv4InterfaceList::const_iterator i = m_interfaces.begin (); 
       i != m_interfaces.end (); 
       i++, interface++)
    {
      ...
      if (ipv4Interface->GetDevice () == device)
        {
          if (ipv4Interface->IsUp ())
            {
              m_rxTrace (packet, m_node->GetObject<Ipv4Multicast> (), interface);
              break;
            }
          else
            {
              ...
              m_dropTrace (ipHeader, packet, DROP_INTERFACE_DOWN, m_node->GetObject<Ipv4Multicast> (), interface);
              return;
            }
        }
    }
  ...
  if (!ipHeader.IsChecksumOk ()) 
    {
      ...
      m_dropTrace (ipHeader, packet, DROP_BAD_CHECKSUM, m_node->GetObject<Ipv4Multicast> (), interface);
      return;
    }
  ...
  for (SocketList::iterator i = m_sockets.begin (); i != m_sockets.end (); ++i)
    {
      ...
      Ptr<Ipv4RawSocketImplMulticast> socket = *i;
      socket->ForwardUp (packet, ipHeader, ipv4Interface);
    }

  NS_ASSERT_MSG (m_routingProtocol != 0, "Need a routing protocol object to process packets");
  if (!m_routingProtocol->RouteInput (packet, ipHeader, device,
                                      MakeCallback (&Ipv4L3ProtocolMulticast::IpForward, this),
                                      MakeCallback (&Ipv4L3ProtocolMulticast::IpMulticastForward, this),
                                      MakeCallback (&Ipv4L3ProtocolMulticast::LocalDeliver, this),
                                      MakeCallback (&Ipv4L3ProtocolMulticast::RouteInputError, this)
                                      ))
    {
      NS_LOG_WARN ("No route found for forwarding packet.  Drop.");
      m_dropTrace (ipHeader, packet, DROP_NO_ROUTE, m_node->GetObject<Ipv4Multicast> (), interface);
    }
}
...
bool
Ipv4L3ProtocolMulticast::IsUnicast (Ipv4Address ad, Ipv4Mask interfaceMask) const
{
...
void 
Ipv4L3ProtocolMulticast::SendWithHeader (Ptr<Packet> packet, 
                                Ipv4Header ipHeader,
                                Ptr<Ipv4Route> route)
{
...
void 
Ipv4L3ProtocolMulticast::Send (Ptr<Packet> packet, 
                      Ipv4Address source,
                      ...
                      Ptr<Ipv4Route> route)
{
      ...
      for (uint32_t j = 0; j < GetNAddresses (ifaceIndex); j++)
        {
          ...
          if (destination.IsSubnetDirectedBroadcast (ifAddr.GetMask ()) && 
            ...
            {
              NS_LOG_LOGIC ("Ipv4L3ProtocolMulticast::Send case 2:  subnet directed bcast to " << ifAddr.GetLocal ());
              ipHeader = BuildHeader (source, destination, protocol, packet->GetSize (), ttl, tos, mayFragment);
              Ptr<Packet> packetCopy = packet->Copy ();
              m_sendOutgoingTrace (ipHeader, packetCopy, ifaceIndex);
              packetCopy->AddHeader (ipHeader);
  ...
  if (route && route->GetGateway () != Ipv4Address ())
    {
      NS_LOG_LOGIC ("Ipv4L3ProtocolMulticast::Send case 3:  passed in with route");
      ipHeader = BuildHeader (source, destination, protocol, packet->GetSize (), ttl, tos, mayFragment);
  ...
  if (route && route->GetGateway () == Ipv4Address ())
    {
      ...
      // to be queried).
      NS_FATAL_ERROR ("Ipv4L3ProtocolMulticast::Send case 4: This case not yet implemented");
    }
  // 5) packet is not broadcast, and route is NULL (e.g., a raw socket call)
  NS_LOG_LOGIC ("Ipv4L3ProtocolMulticast::Send case 5:  passed in with no route " << destination);
  ...
  if (m_routingProtocol != 0)
    ...
    {
      NS_LOG_ERROR ("Ipv4L3ProtocolMulticast::Send: m_routingProtocol == 0");
    }
  if (newRoute)
    {
  ...
  else
    {
      ...
      m_dropTrace (ipHeader, packet, DROP_NO_ROUTE, m_node->GetObject<Ipv4Multicast> (), 0);
    }
}
...
Ipv4Header
Ipv4L3ProtocolMulticast::BuildHeader (
  Ipv4Address source,
  Ipv4Address destination,
  uint8_t protocol,
...
void
Ipv4L3ProtocolMulticast::SendRealOut (Ptr<Ipv4Route> route,
                             Ptr<Packet> packet,
                             Ipv4Header const &ipHeader)
{
  ...
  Ptr<Ipv4InterfaceMulticast> outInterface = GetInterface (interface);
          ...
          if ( packet->GetSize () > outInterface->GetDevice ()->GetMtu () )
            {
              ...
              for ( std::list<Ptr<Packet> >::iterator it = listFragments.begin (); it != listFragments.end (); it++ )
                {
                  m_txTrace (*it, m_node->GetObject<Ipv4Multicast> (), interface);
                  outInterface->Send (*it, route->GetGateway ());
                }
            }
          else
            {
              m_txTrace (packet, m_node->GetObject<Ipv4Multicast> (), interface);
...
void
Ipv4L3ProtocolMulticast::IpMulticastForward (Ptr<Ipv4MulticastRoute> mrtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
      ...
      if (h.GetTtl () == 0)
        {
          ...
          m_dropTrace (header, packet, DROP_TTL_EXPIRED, m_node->GetObject<Ipv4Multicast> (), interfaceId);
          return;
        }
...
void
Ipv4L3ProtocolMulticast::IpForward (Ptr<Ipv4Route> rtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
  ...
  if (ipHeader.GetTtl () == 0)
    {
      ...
      NS_LOG_WARN ("TTL exceeded.  Drop.");
      m_dropTrace (header, packet, DROP_TTL_EXPIRED, m_node->GetObject<Ipv4Multicast> (), interface);
      return;
    }
...
void
Ipv4L3ProtocolMulticast::LocalDeliver (Ptr<const Packet> packet, Ipv4Header const&ip, uint32_t iif)
{
  ...
  Ptr<IpL4ProtocolMulticast> protocol = GetProtocol (ipHeader.GetProtocol (), iif);
  if (protocol != 0)
    {
      // we need to make a copy in the unlikely event we hit the
      // RX_ENDPOINT_UNREACH codepath
      Ptr<Packet> copy = p->Copy ();
      enum IpL4ProtocolMulticast::RxStatus status = 
        protocol->Receive (p, ipHeader, GetInterface (iif));
      switch (status) {
        case IpL4ProtocolMulticast::RX_OK:
        // fall through
        case IpL4ProtocolMulticast::RX_ENDPOINT_CLOSED:
        // fall through
        case IpL4ProtocolMulticast::RX_CSUM_FAILED:
          break;
        case IpL4ProtocolMulticast::RX_ENDPOINT_UNREACH:
...
bool
Ipv4L3ProtocolMulticast::AddAddress (uint32_t i, Ipv4InterfaceAddress address)
{
  NS_LOG_FUNCTION (this << i << address);
  Ptr<Ipv4InterfaceMulticast> interface = GetInterface (i);
...
Ipv4L3ProtocolMulticast::GetAddress (uint32_t interfaceIndex, uint32_t addressIndex) const
{
  NS_LOG_FUNCTION (this << interfaceIndex << addressIndex);
  Ptr<Ipv4InterfaceMulticast> interface = GetInterface (interfaceIndex);
  return interface->GetAddress (addressIndex);
}

uint32_t 
Ipv4L3ProtocolMulticast::GetNAddresses (uint32_t interface) const
{
  NS_LOG_FUNCTION (this << interface);
  Ptr<Ipv4InterfaceMulticast> iface = GetInterface (interface);
  return iface->GetNAddresses ();
}

bool
Ipv4L3ProtocolMulticast::RemoveAddress (uint32_t i, uint32_t addressIndex)
{
...
bool
Ipv4L3ProtocolMulticast::RemoveAddress (uint32_t i, Ipv4Address address)
{
  NS_LOG_FUNCTION (this << i << address);
...
Ipv4Address 
Ipv4L3ProtocolMulticast::SelectSourceAddress (Ptr<const NetDevice> device,
...
void 
Ipv4L3ProtocolMulticast::SetMetric (uint32_t i, uint16_t metric)
{
...
uint16_t
Ipv4L3ProtocolMulticast::GetMetric (uint32_t i) const
{
...
uint16_t 
Ipv4L3ProtocolMulticast::GetMtu (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4InterfaceMulticast> interface = GetInterface (i);
...
bool 
Ipv4L3ProtocolMulticast::IsUp (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4InterfaceMulticast> interface = GetInterface (i);
...
void 
Ipv4L3ProtocolMulticast::SetUp (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4InterfaceMulticast> interface = GetInterface (i);
...
void 
Ipv4L3ProtocolMulticast::SetDown (uint32_t ifaceIndex)
{
  NS_LOG_FUNCTION (this << ifaceIndex);
  Ptr<Ipv4InterfaceMulticast> interface = GetInterface (ifaceIndex);
  interface->SetDown ();
...
bool 
Ipv4L3ProtocolMulticast::IsForwarding (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4InterfaceMulticast> interface = GetInterface (i);
...
void 
Ipv4L3ProtocolMulticast::SetForwarding (uint32_t i, bool val)
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4InterfaceMulticast> interface = GetInterface (i);
...
Ptr<NetDevice>
Ipv4L3ProtocolMulticast::GetNetDevice (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
...
void 
Ipv4L3ProtocolMulticast::SetIpForward (bool forward) 
{
...
bool 
Ipv4L3ProtocolMulticast::GetIpForward (void) const
{
  NS_LOG_FUNCTION (this);
  return m_ipForward;
}
...
void 
Ipv4L3ProtocolMulticast::SetWeakEsModel (bool model)
{
...
bool 
Ipv4L3ProtocolMulticast::GetWeakEsModel (void) const
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4L3ProtocolMulticast::RouteInputError (Ptr<const Packet> p, const Ipv4Header & ipHeader, Socket::SocketErrno sockErrno)
{
  NS_LOG_FUNCTION (this << p << ipHeader << sockErrno);
  NS_LOG_LOGIC ("Route input failure-- dropping packet to " << ipHeader << " with errno " << sockErrno); 
  m_dropTrace (ipHeader, p, DROP_ROUTE_ERROR, m_node->GetObject<Ipv4Multicast> (), 0);
}

void
Ipv4L3ProtocolMulticast::DoFragmentation (Ptr<Packet> packet, uint32_t outIfaceMtu, std::list<Ptr<Packet> >& listFragments)
{
...
bool
Ipv4L3ProtocolMulticast::ProcessFragment (Ptr<Packet>& packet, Ipv4Header& ipHeader, uint32_t iif)
{
  ...
  if (it == m_fragments.end ())
    {
      ...
      m_fragmentsTimers[key] = Simulator::Schedule (m_fragmentExpirationTimeout,
                                                    &Ipv4L3ProtocolMulticast::HandleFragmentsTimeout, this,
                                                    key, ipHeader, iif);
    }
  else
    {
...
Ipv4L3ProtocolMulticast::Fragments::Fragments ()
  : m_moreFragment (0)
{
  NS_LOG_FUNCTION (this);
}
...
void
Ipv4L3ProtocolMulticast::Fragments::AddFragment (Ptr<Packet> fragment, uint16_t fragmentOffset, bool moreFragment)
{
...
bool
Ipv4L3ProtocolMulticast::Fragments::IsEntire () const
{
  NS_LOG_FUNCTION (this);
...
Ptr<Packet>
Ipv4L3ProtocolMulticast::Fragments::GetPacket () const
{
  NS_LOG_FUNCTION (this);
...
Ptr<Packet>
Ipv4L3ProtocolMulticast::Fragments::GetPartialPacket () const
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4L3ProtocolMulticast::HandleFragmentsTimeout (std::pair<uint64_t, uint32_t> key, Ipv4Header & ipHeader, uint32_t iif)
{
