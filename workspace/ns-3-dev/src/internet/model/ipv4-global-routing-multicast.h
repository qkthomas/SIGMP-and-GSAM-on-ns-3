...
#ifndef IPV4_GLOBAL_ROUTING_MULTICAST_H
#define IPV4_GLOBAL_ROUTING_MULTICAST_H
 ...
 *
 * As an option to running a dynamic routing protocol, a GlobalRouteManagerMulticast
 ...
 * somewhere in the node, so therefore this class Ipv4GlobalRoutingMulticast
 ...
 *
 * This class deals with Ipv4Multicast unicast routes only.
 *
 * \see Ipv4RoutingProtocolMulticast
 * \see GlobalRouteManagerMulticast
 */
class Ipv4GlobalRoutingMulticast : public Ipv4RoutingProtocolMulticast
{
public:
  /**
  ...
  /**
   * \brief Construct an empty Ipv4GlobalRoutingMulticast routing protocol,
   *
   * The Ipv4GlobalRoutingMulticast class supports host and network unicast routes.
   * This method initializes the lists containing these routes to empty.
   *
   * \see Ipv4GlobalRoutingMulticast
   */
  Ipv4GlobalRoutingMulticast ();
  virtual ~Ipv4GlobalRoutingMulticast ();
   ...
   * \see Ipv4GlobalRoutingMulticast::RemoveRoute
   */
   ...
   *
   * \see Ipv4RoutingTableEntry
   * \see Ipv4GlobalRoutingMulticast::GetRoute
   * \see Ipv4GlobalRoutingMulticast::AddRoute
   */
...
private:
  ...
  Ptr<Ipv4Multicast> m_ipv4; //!< associated IPv4 instance
};
