...
//added by Lin Chen
//#include "global-route-manager-impl.cc"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("GlobalRouteManagerImplMulticast");
...
extern std::ostream&
operator<< (std::ostream& os, const SPFVertexMulticast::NodeExit_t& exit);

std::ostream&
operator<< (std::ostream& os, const SPFVertexMulticast::ListOfSPFVertex_t& vs)
{
  typedef SPFVertexMulticast::ListOfSPFVertex_t::const_iterator CIter_t;
  os << "{";
...
// ---------------------------------------------------------------------------
//
// SPFVertexMulticast Implementation
//
// ---------------------------------------------------------------------------

SPFVertexMulticast::SPFVertexMulticast () : 
  m_vertexType (VertexUnknown), 
  m_vertexId ("255.255.255.255"), 
  m_lsa (0),
  m_distanceFromRoot (SPF_INFINITY_MULTICAST),
  m_rootOif (SPF_INFINITY_MULTICAST),
  m_nextHop ("0.0.0.0"),
  m_parents (),
  m_children (),
...
SPFVertexMulticast::SPFVertexMulticast (GlobalRoutingLSAMulticast* lsa) : 
  ...
  m_vertexProcessed (false)
{
  ...
  if (lsa->GetLSType () == GlobalRoutingLSAMulticast::RouterLSA) 
    {
      NS_LOG_LOGIC ("Setting m_vertexType to VertexRouter");
      m_vertexType = SPFVertexMulticast::VertexRouter;
    }
  else if (lsa->GetLSType () == GlobalRoutingLSAMulticast::NetworkLSA) 
    { 
      NS_LOG_LOGIC ("Setting m_vertexType to VertexNetwork");
      m_vertexType = SPFVertexMulticast::VertexNetwork;
    }
}
  ...
  while (m_children.size () > 0)
    {
      ...
      SPFVertexMulticast* p = m_children.front ();
...
void
SPFVertexMulticast::SetVertexType (SPFVertexMulticast::VertexType type)
{
  NS_LOG_FUNCTION (this << type);
  m_vertexType = type;
}

SPFVertexMulticast::VertexType
SPFVertexMulticast::GetVertexType (void) const
{
  NS_LOG_FUNCTION (this);
  return m_vertexType;
}
...
void
SPFVertexMulticast::SetVertexId (Ipv4Address id)
{
...
Ipv4Address
SPFVertexMulticast::GetVertexId (void) const
{
  NS_LOG_FUNCTION (this);
  return m_vertexId;
}
...
void
SPFVertexMulticast::SetLSA (GlobalRoutingLSAMulticast* lsa)
{
  NS_LOG_FUNCTION (this << lsa);
  m_lsa = lsa;
}
...
SPFVertexMulticast::GetLSA (void) const
{
  NS_LOG_FUNCTION (this);
  return m_lsa;
}
...
void
SPFVertexMulticast::SetDistanceFromRoot (uint32_t distance)
{
...
uint32_t
SPFVertexMulticast::GetDistanceFromRoot (void) const
{
  NS_LOG_FUNCTION (this);
...
void
SPFVertexMulticast::SetParent (SPFVertexMulticast* parent)
{
...
SPFVertexMulticast*
SPFVertexMulticast::GetParent (uint32_t i) const
{
  ...
  if (m_parents.size () <= i)
    {
      NS_LOG_LOGIC ("Index to SPFVertexMulticast's parent is out-of-range.");
      return 0;
    }
...
void 
SPFVertexMulticast::MergeParent (const SPFVertexMulticast* v)
{
...
void 
SPFVertexMulticast::SetRootExitDirection (Ipv4Address nextHop, int32_t id)
{
...
void 
SPFVertexMulticast::SetRootExitDirection (SPFVertexMulticast::NodeExit_t exit)
{
  NS_LOG_FUNCTION (this << exit);
  SetRootExitDirection (exit.first, exit.second);
}

SPFVertexMulticast::NodeExit_t
SPFVertexMulticast::GetRootExitDirection (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  typedef ListOfNodeExit_t::const_iterator CIter_t;

  NS_ASSERT_MSG (i < m_ecmpRootExits.size (), "Index out-of-range when accessing SPFVertexMulticast::m_ecmpRootExits!");
...
SPFVertexMulticast::NodeExit_t
SPFVertexMulticast::GetRootExitDirection () const
{
  NS_LOG_FUNCTION (this);
...
void 
SPFVertexMulticast::MergeRootExitDirections (const SPFVertexMulticast* vertex)
{
...
void 
SPFVertexMulticast::InheritAllRootExitDirections (const SPFVertexMulticast* vertex)
{
  NS_LOG_FUNCTION (this << vertex);
...
uint32_t 
SPFVertexMulticast::GetNRootExitDirections () const
{
  NS_LOG_FUNCTION (this);
...
uint32_t 
SPFVertexMulticast::GetNChildren (void) const
{
  NS_LOG_FUNCTION (this);
...
SPFVertexMulticast*
SPFVertexMulticast::GetChild (uint32_t n) const
{
...
uint32_t
SPFVertexMulticast::AddChild (SPFVertexMulticast* child)
{
...
void 
SPFVertexMulticast::SetVertexProcessed (bool value)
{
...
bool 
SPFVertexMulticast::IsVertexProcessed (void) const
{
  NS_LOG_FUNCTION (this);
...
void
SPFVertexMulticast::ClearVertexProcessed (void)
{
  NS_LOG_FUNCTION (this);
...
// ---------------------------------------------------------------------------
//
// GlobalRouteManagerLSDBMulticast Implementation
//
// ---------------------------------------------------------------------------

GlobalRouteManagerLSDBMulticast::GlobalRouteManagerLSDBMulticast ()
  :
    m_database (),
    m_extdatabase ()
{
  ...
  for (i= m_database.begin (); i!= m_database.end (); i++)
    {
      ...
      GlobalRoutingLSAMulticast* temp = i->second;
      delete temp;
    }
  for (uint32_t j = 0; j < m_extdatabase.size (); j++)
    {
      NS_LOG_LOGIC ("free ASexternalLSA");
      GlobalRoutingLSAMulticast* temp = m_extdatabase.at (j);
      delete temp;
    }
...
void
GlobalRouteManagerLSDBMulticast::Initialize ()
{
  NS_LOG_FUNCTION (this);
  LSDBMap_t::iterator i;
  for (i= m_database.begin (); i!= m_database.end (); i++)
    {
      GlobalRoutingLSAMulticast* temp = i->second;
      temp->SetStatus (GlobalRoutingLSAMulticast::LSA_SPF_NOT_EXPLORED);
    }
}

void
GlobalRouteManagerLSDBMulticast::Insert (Ipv4Address addr, GlobalRoutingLSAMulticast* lsa)
{
  NS_LOG_FUNCTION (this << addr << lsa);
  if (lsa->GetLSType () == GlobalRoutingLSAMulticast::ASExternalLSAs) 
    {
...
GlobalRoutingLSAMulticast*
GlobalRouteManagerLSDBMulticast::GetExtLSA (uint32_t index) const
{
...
uint32_t
GlobalRouteManagerLSDBMulticast::GetNumExtLSAs () const
{
  NS_LOG_FUNCTION (this);
...
GlobalRoutingLSAMulticast*
GlobalRouteManagerLSDBMulticast::GetLSA (Ipv4Address addr) const
{
...
GlobalRoutingLSAMulticast*
GlobalRouteManagerLSDBMulticast::GetLSAByLinkData (Ipv4Address addr) const
{
  NS_LOG_FUNCTION (this << addr);
//
// Look up an LSA by its address.
...
// Iterate among temp's Link Records
      for (uint32_t j = 0; j < temp->GetNLinkRecords (); j++)
        {
          GlobalRoutingLinkRecordMulticast *lr = temp->GetLinkRecord (j);
          if ( lr->GetLinkType () == GlobalRoutingLinkRecordMulticast::TransitNetwork &&
               lr->GetLinkData () == addr)
            {
              return temp;
            }
...
// ---------------------------------------------------------------------------
//
// GlobalRouteManagerImplMulticast Implementation
//
// ---------------------------------------------------------------------------

GlobalRouteManagerImplMulticast::GlobalRouteManagerImplMulticast () 
  :
    m_spfroot (0)
{
  NS_LOG_FUNCTION (this);
  m_lsdb = new GlobalRouteManagerLSDBMulticast ();
}
...
void
GlobalRouteManagerImplMulticast::DebugUseLsdb (GlobalRouteManagerLSDBMulticast* lsdb)
{
...
void
GlobalRouteManagerImplMulticast::DeleteGlobalRoutes ()
{
  NS_LOG_FUNCTION (this);
  ...
  for (NodeList::Iterator i = NodeList::Begin (); i != listEnd; i++)
    {
      Ptr<Node> node = *i;
      Ptr<GlobalRouterMulticast> router = node->GetObject<GlobalRouterMulticast> ();
      if (router == 0)
        {
          continue;
        }
      Ptr<Ipv4GlobalRoutingMulticast> gr = router->GetRoutingProtocol ();
      uint32_t j = 0;
...
// in the system and look for those that support the GlobalRouterMulticast interface.
...
//
void
GlobalRouteManagerImplMulticast::BuildGlobalRoutingDatabase () 
{
  NS_LOG_FUNCTION (this);
//
// Walk the list of nodes looking for the GlobalRouterMulticast Interface.  Nodes with
  ...
  for (NodeList::Iterator i = NodeList::Begin (); i != listEnd; i++)
    {
      ...
      Ptr<GlobalRouterMulticast> rtr = node->GetObject<GlobalRouterMulticast> ();
//
...
// the GlobalRouterMulticast.  Afterward, you may use GetNumLSAs (), which is a very
...
// found.
//
      Ptr<Ipv4GlobalRoutingMulticast> grouting = rtr->GetRoutingProtocol ();
      uint32_t numLSAs = rtr->DiscoverLSAs ();
      NS_LOG_LOGIC ("Found " << numLSAs << " LSAs");

      for (uint32_t j = 0; j < numLSAs; ++j)
        {
          GlobalRoutingLSAMulticast* lsa = new GlobalRoutingLSAMulticast ();
//
...
// of an aggregated GlobalRouterMulticast interface), run the Dijkstra SPF calculation
...
//
void
GlobalRouteManagerImplMulticast::InitializeRoutes ()
{
  NS_LOG_FUNCTION (this);
//
  ...
  for (NodeList::Iterator i = NodeList::Begin (); i != listEnd; i++)
    {
      Ptr<Node> node = *i;
//
// Look for the GlobalRouterMulticast interface that indicates that the node is
// participating in routing.
//
      Ptr<GlobalRouterMulticast> rtr = 
        node->GetObject<GlobalRouterMulticast> ();
...
//
void
GlobalRouteManagerImplMulticast::SPFNext (SPFVertexMulticast* v, CandidateQueueMulticast& candidate)
{
  NS_LOG_FUNCTION (this << v << &candidate);

  SPFVertexMulticast* w = 0;
  GlobalRoutingLSAMulticast* w_lsa = 0;
  GlobalRoutingLinkRecordMulticast *l = 0;
  uint32_t distance = 0;
...
//
  if (v->GetVertexType () == SPFVertexMulticast::VertexRouter)
    {
      numRecordsInVertex = v->GetLSA ()->GetNLinkRecords (); 
    }
  if (v->GetVertexType () == SPFVertexMulticast::VertexNetwork)
    {
...
//
          ...
          NS_ASSERT (l != 0);
          if (l->GetLinkType () == GlobalRoutingLinkRecordMulticast::StubNetwork)
            {
...
// database. 
//
          if (l->GetLinkType () == GlobalRoutingLinkRecordMulticast::PointToPoint)
            {
//
...
//
              ...
              NS_LOG_LOGIC ("Found a P2P record from " << 
                   ...
                   GlobalRoutingLinkRecordMulticast::TransitNetwork)
            {
              w_lsa = m_lsdb->GetLSA (l->GetLinkId ());
              NS_ASSERT (w_lsa);
...
//
      if (w_lsa->GetStatus () == GlobalRoutingLSAMulticast::LSA_SPF_IN_SPFTREE) 
        {
...
//
      if (v->GetLSA ()->GetLSType () == GlobalRoutingLSAMulticast::RouterLSA)
        {
          NS_ASSERT (l != 0);
...
// Is there already vertex w in candidate list?
      if (w_lsa->GetStatus () == GlobalRoutingLSAMulticast::LSA_SPF_NOT_EXPLORED)
        {
...
// prepare vertex w
          w = new SPFVertexMulticast (w_lsa);
          if (SPFNexthopCalculation (v, w, l, distance))
            {
              w_lsa->SetStatus (GlobalRoutingLSAMulticast::LSA_SPF_CANDIDATE);
//
...
//
      ...
      else if (w_lsa->GetStatus () == GlobalRoutingLSAMulticast::LSA_SPF_CANDIDATE)
        {
//
...
// is very different from quagga (blame ns3::GlobalRouteManagerImplMulticast)
...
// SPFVertexMulticast checks if the vertex and its parent is linked
// bidirectionally
...
//
int
GlobalRouteManagerImplMulticast::SPFNexthopCalculation (
  SPFVertexMulticast* v, 
  SPFVertexMulticast* w,
  GlobalRoutingLinkRecordMulticast* l,
  uint32_t distance)
{
...
/*
  if (w->GetVertexType () == SPFVertexMulticast::VertexNetwork && l)
    {
...
// is a router.
//
      if (w->GetVertexType () == SPFVertexMulticast::VertexRouter) 
        {
//
...
//
          NS_ASSERT (l);
          GlobalRoutingLinkRecordMulticast *linkRemote = 0;
...
//
        ...
        {
          NS_ASSERT (w->GetVertexType () == SPFVertexMulticast::VertexNetwork);
// W is a directly connected network; no next hop is required
          GlobalRoutingLSAMulticast* w_lsa = w->GetLSA ();
          NS_ASSERT (w_lsa->GetLSType () == GlobalRoutingLSAMulticast::NetworkLSA);
...
// Set the next hop to 0.0.0.0 meaning "not exist"
  ...
  else if (v->GetVertexType () == SPFVertexMulticast::VertexNetwork) 
    {
...
// examining the destination's router-LSA...
          NS_ASSERT (w->GetVertexType () == SPFVertexMulticast::VertexRouter);
          GlobalRoutingLinkRecordMulticast *linkRemote = 0;
...
GlobalRouteManagerImplMulticast::SPFGetNextLink (
  SPFVertexMulticast* v,
  SPFVertexMulticast* w,
  GlobalRoutingLinkRecordMulticast* prev_link) 
{
...
//
void
GlobalRouteManagerImplMulticast::DebugSPFCalculate (Ipv4Address root)
{
...
//
bool
GlobalRouteManagerImplMulticast::CheckForStubNode (Ipv4Address root)
{
  NS_LOG_FUNCTION (this << root);
  GlobalRoutingLSAMulticast *rlsa = m_lsdb->GetLSA (root);
  Ipv4Address myRouterId = rlsa->GetLinkStateId ();
  int transits = 0;
  GlobalRoutingLinkRecordMulticast *transitLink = 0;
  for (uint32_t i = 0; i < rlsa->GetNLinkRecords (); i++)
    {
      GlobalRoutingLinkRecordMulticast *l = rlsa->GetLinkRecord (i);
      if (l->GetLinkType () == GlobalRoutingLinkRecordMulticast::TransitNetwork)
        {
          transits++;
          transitLink = l;
        }
      else if (l->GetLinkType () == GlobalRoutingLinkRecordMulticast::PointToPoint)
        {
          transits++;
          transitLink = l;
        }
  ...
  if (transits == 1)
    {
      if (transitLink->GetLinkType () == GlobalRoutingLinkRecordMulticast::TransitNetwork)
        {
      ...
      else if (transitLink->GetLinkType () == GlobalRoutingLinkRecordMulticast::PointToPoint)
        {
          ...
          GlobalRoutingLSAMulticast *w_lsa = m_lsdb->GetLSA (transitLink->GetLinkId ());
          ...
          for (uint32_t j = 0; j < nLinkRecords; ++j)
            {
              ...
              //
              GlobalRoutingLinkRecordMulticast *lr = w_lsa->GetLinkRecord (j);
              if (lr->GetLinkType () != GlobalRoutingLinkRecordMulticast::PointToPoint)
                {
                  continue;
                }
              ...
              if (lr->GetLinkId () == myRouterId)
                {
                  ...
                  Ptr<GlobalRouterMulticast> router = rlsa->GetNode ()->GetObject<GlobalRouterMulticast> ();
                  NS_ASSERT (router);
                  Ptr<Ipv4GlobalRoutingMulticast> gr = router->GetRoutingProtocol ();
                  NS_ASSERT (gr);
...
void
GlobalRouteManagerImplMulticast::SPFCalculate (Ipv4Address root)
{
  NS_LOG_FUNCTION (this << root);
...
//
  m_lsdb->Initialize ();
//
// The candidate queue is a priority queue of SPFVertexMulticast objects, with the top
// of the queue being the closest vertex in terms of distance from the root
// of the tree.  Initially, this queue is empty.
//
  CandidateQueueMulticast candidate;
...
//
  v = new SPFVertexMulticast (m_lsdb->GetLSA (root));
// 
...
//
  ...
  v->GetLSA ()->SetStatus (GlobalRoutingLSAMulticast::LSA_SPF_IN_SPFTREE);
...
// list in the process).
//
// Recall that in the previous step, we created SPFVertexMulticast structures for each
...
// for.  It looks for the Ipv4Multicast interface of that node and remembers it.  So
...
//
      if (v->GetVertexType () == SPFVertexMulticast::VertexRouter)
        ...
        {
          NS_ASSERT_MSG (0, "illegal SPFVertexMulticast type");
        }
//
// RFC2328 16.1. (5). 
//
  ...
  for (uint32_t i = 0; i < m_lsdb->GetNumExtLSAs (); i++)
    {
      ...
      GlobalRoutingLSAMulticast *extlsa = m_lsdb->GetExtLSA (i);
...
void
GlobalRouteManagerImplMulticast::ProcessASExternals (SPFVertexMulticast* v, GlobalRoutingLSAMulticast* extlsa)
{
  ...
  if (v->GetVertexType () == SPFVertexMulticast::VertexRouter)
    {
      GlobalRoutingLSAMulticast *rlsa = v->GetLSA ();
...
void
GlobalRouteManagerImplMulticast::SPFAddASExternal (GlobalRoutingLSAMulticast *extlsa, SPFVertexMulticast *v)
{
  NS_LOG_FUNCTION (this << extlsa << v);

  NS_ASSERT_MSG (m_spfroot, "GlobalRouteManagerImplMulticast::SPFAddASExternal (): Root pointer not set");
  ...
  for (; i != listEnd; i++)
    {
      Ptr<Node> node = *i;
//
// The router ID is accessible through the GlobalRouterMulticast interface, so we need
// to QI for that interface.  If there's no GlobalRouterMulticast interface, the node
...
// 
      ...
      if (rtr == 0)
        {
          NS_LOG_LOGIC ("No GlobalRouterMulticast interface on node " << node->GetId ());
          continue;
        }
//
...
//
// Routing information is updated using the Ipv4Multicast interface.  We need to QI
// for that interface.  If the node is acting as an IP version 4 router, it
// should absolutely have an Ipv4Multicast interface.
//
          Ptr<Ipv4Multicast> ipv4 = node->GetObject<Ipv4Multicast> ();
          NS_ASSERT_MSG (ipv4, 
                         "GlobalRouteManagerImplMulticast::SPFIntraAddRouter (): "
                         "QI for <Ipv4Multicast> interface failed");
//
...
//
          NS_ASSERT_MSG (v->GetLSA (), 
                         "GlobalRouteManagerImplMulticast::SPFIntraAddRouter (): "
                         "Expected valid LSA in SPFVertexMulticast* v");
...
//
          ...
          for (uint32_t i = 0; i < v->GetNRootExitDirections (); i++)
            {
              SPFVertexMulticast::NodeExit_t exit = v->GetRootExitDirection (i);
...
void
GlobalRouteManagerImplMulticast::SPFProcessStubs (SPFVertexMulticast* v)
{
  NS_LOG_FUNCTION (this << v);
      ...
      for (uint32_t i = 0; i < rlsa->GetNLinkRecords (); i++)
        {
          NS_LOG_LOGIC ("Examining link " << i << " of " << 
                        v->GetVertexId () << "'s " <<
                        v->GetLSA ()->GetNLinkRecords () << " link records");
          GlobalRoutingLinkRecordMulticast *l = v->GetLSA ()->GetLinkRecord (i);
          if (l->GetLinkType () == GlobalRoutingLinkRecordMulticast::StubNetwork)
            {
              NS_LOG_LOGIC ("Found a Stub record to " << l->GetLinkId ());
              SPFIntraAddStub (l, v);
...
void
GlobalRouteManagerImplMulticast::SPFIntraAddStub (GlobalRoutingLinkRecordMulticast *l, SPFVertexMulticast* v)
{
  NS_LOG_FUNCTION (this << l << v);

  NS_ASSERT_MSG (m_spfroot, 
                 "GlobalRouteManagerImplMulticast::SPFIntraAddStub (): Root pointer not set");
...
// 
      ...
      if (rtr == 0)
        {
          NS_LOG_LOGIC ("No GlobalRouterMulticast interface on node " << 
                        node->GetId ());
          continue;
        }
//
...
//
int32_t
GlobalRouteManagerImplMulticast::FindOutgoingInterfaceId (Ipv4Address a, Ipv4Mask amask)
{
...
// the node corresponding to the vertex ID, find the Ipv4Multicast interface on that
  ...
  for (; i != listEnd; i++)
    {
      ...
      Ptr<GlobalRouterMulticast> rtr = 
        node->GetObject<GlobalRouterMulticast> ();
//
// If the node doesn't have a GlobalRouterMulticast interface it can't be the one
// we're interested in.
//
      if (rtr == 0)
        {
...
// the Ipv4Multicast interface to look for the ipv4 interface index.  Since this node
// is participating in routing IP version 4 packets, it certainly must have 
// an Ipv4Multicast interface.
//
          Ptr<Ipv4Multicast> ipv4 = node->GetObject<Ipv4Multicast> ();
          NS_ASSERT_MSG (ipv4, 
                         "GlobalRouteManagerImplMulticast::FindOutgoingInterfaceId (): "
                         "GetObject for <Ipv4Multicast> interface failed");
//
...
//
          ...
          if (interface < 0)
            {
              NS_FATAL_ERROR ("GlobalRouteManagerImplMulticast::FindOutgoingInterfaceId(): "
...
//
void
GlobalRouteManagerImplMulticast::SPFIntraAddRouter (SPFVertexMulticast* v)
{
  NS_LOG_FUNCTION (this << v);

  NS_ASSERT_MSG (m_spfroot, 
                 "GlobalRouteManagerImplMulticast::SPFIntraAddRouter (): Root pointer not set");
//
// The root of the Shortest Path First tree is the router to which we are 
// going to write the actual routing table entries.  The vertex corresponding
// to this router has a vertex ID which is the router ID of that node.  We're
...
//
// The router ID is accessible through the GlobalRouterMulticast interface, so we need
// to GetObject for that interface.  If there's no GlobalRouterMulticast interface, 
      ...
      if (rtr->GetRouterId () == routerId)
        {
          NS_LOG_LOGIC ("Setting routes for node " << node->GetId ());
//
// Routing information is updated using the Ipv4Multicast interface.  We need to 
// GetObject for that interface.  If the node is acting as an IP version 4 
// router, it should absolutely have an Ipv4Multicast interface.
//
          Ptr<Ipv4Multicast> ipv4 = node->GetObject<Ipv4Multicast> ();
          NS_ASSERT_MSG (ipv4, 
                         "GlobalRouteManagerImplMulticast::SPFIntraAddRouter (): "
...
// to be interested in the records corresponding to point-to-point links.
//
          GlobalRoutingLSAMulticast *lsa = v->GetLSA ();
          NS_ASSERT_MSG (lsa, 
                         "GlobalRouteManagerImplMulticast::SPFIntraAddRouter (): "
                         "Expected valid LSA in SPFVertexMulticast* v");
...
// We are only concerned about point-to-point links
//
              GlobalRoutingLinkRecordMulticast *lr = lsa->GetLinkRecord (j);
              if (lr->GetLinkType () != GlobalRoutingLinkRecordMulticast::PointToPoint)
                {
                  continue;
                }
...
void
GlobalRouteManagerImplMulticast::SPFIntraAddTransit (SPFVertexMulticast* v)
{
  NS_LOG_FUNCTION (this << v);

  NS_ASSERT_MSG (m_spfroot, 
                 "GlobalRouteManagerImplMulticast::SPFIntraAddTransit (): Root pointer not set");
//
// The root of the Shortest Path First tree is the router to which we are 
// going to write the actual routing table entries.  The vertex corresponding
// to this router has a vertex ID which is the router ID of that node.  We're
...
//
          Ptr<Ipv4Multicast> ipv4 = node->GetObject<Ipv4Multicast> ();
          NS_ASSERT_MSG (ipv4, 
                         "GlobalRouteManagerImplMulticast::SPFIntraAddTransit (): "
                         "GetObject for <Ipv4Multicast> interface failed");
//
// Get the Global Router Link State Advertisement from the vertex we're
// adding the routes to.  The LSA will have a number of attached Global Router
...
//
void
GlobalRouteManagerImplMulticast::SPFVertexAddParent (SPFVertexMulticast* v)
{
  NS_LOG_FUNCTION (this << v);

  for (uint32_t i=0;;)
    {
      SPFVertexMulticast* parent;
