...
#include "global-route-manager-multicast.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("Ipv4GlobalRoutingMulticast");

NS_OBJECT_ENSURE_REGISTERED (Ipv4GlobalRoutingMulticast);

TypeId 
Ipv4GlobalRoutingMulticast::GetTypeId (void)
{ 
  static TypeId tid = TypeId ("ns3::Ipv4GlobalRoutingMulticast")
    .SetParent<Object> ()
    .SetGroupName ("Internet")
    .AddAttribute ("RandomEcmpRouting",
                   "Set to true if packets are randomly routed among ECMP; set to false for using only one route consistently",
                   BooleanValue (false),
                   MakeBooleanAccessor (&Ipv4GlobalRoutingMulticast::m_randomEcmpRouting),
                   MakeBooleanChecker ())
    .AddAttribute ("RespondToInterfaceEvents",
                   ...
                   BooleanValue (false),
                   MakeBooleanAccessor (&Ipv4GlobalRoutingMulticast::m_respondToInterfaceEvents),
                   MakeBooleanChecker ())
  ;
  return tid;
}

Ipv4GlobalRoutingMulticast::Ipv4GlobalRoutingMulticast () 
...
void 
Ipv4GlobalRoutingMulticast::AddHostRouteTo (Ipv4Address dest, 
                                   Ipv4Address nextHop, 
                                   uint32_t interface)
{
...
void 
Ipv4GlobalRoutingMulticast::AddNetworkRouteTo (Ipv4Address network, 
...
void 
Ipv4GlobalRoutingMulticast::AddASExternalRouteTo (Ipv4Address network, 
                                         Ipv4Mask networkMask,
                                         Ipv4Address nextHop,
                                         uint32_t interface)
{
...
Ptr<Ipv4Route>
Ipv4GlobalRoutingMulticast::LookupGlobal (Ipv4Address dest, Ptr<NetDevice> oif)
{
...
uint32_t 
Ipv4GlobalRoutingMulticast::GetNRoutes (void) const
{
  NS_LOG_FUNCTION (this);
  uint32_t n = 0;
  n += m_hostRoutes.size ();
...
Ipv4GlobalRoutingMulticast::GetRoute (uint32_t index) const
{
...
void 
Ipv4GlobalRoutingMulticast::RemoveRoute (uint32_t index)
{
  NS_LOG_FUNCTION (this << index);
  if (index < m_hostRoutes.size ())
    {
...
int64_t
Ipv4GlobalRoutingMulticast::AssignStreams (int64_t stream)
{
...
void
Ipv4GlobalRoutingMulticast::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
  for (HostRoutesI i = m_hostRoutes.begin (); 
       i != m_hostRoutes.end (); 
...
void
Ipv4GlobalRoutingMulticast::PrintRoutingTable (Ptr<OutputStreamWrapper> stream) const
{
  NS_LOG_FUNCTION (this << stream);
  ...
  *os << "Node: " << m_ipv4->GetObject<Node> ()->GetId ()
      ...
      << ", Ipv4GlobalRoutingMulticast table" << std::endl;
...
Ptr<Ipv4Route>
Ipv4GlobalRoutingMulticast::RouteOutput (Ptr<Packet> p, const Ipv4Header &header, Ptr<NetDevice> oif, Socket::SocketErrno &sockerr)
{
...
bool 
Ipv4GlobalRoutingMulticast::RouteInput  (Ptr<const Packet> p, const Ipv4Header &header, Ptr<const NetDevice> idev,                             UnicastForwardCallback ucb, MulticastForwardCallback mcb,
...
void 
Ipv4GlobalRoutingMulticast::NotifyInterfaceUp (uint32_t i)
{
...
void 
Ipv4GlobalRoutingMulticast::NotifyInterfaceDown (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
  if (m_respondToInterfaceEvents && Simulator::Now ().GetSeconds () > 0)  // avoid startup events
    {
...
void 
Ipv4GlobalRoutingMulticast::NotifyAddAddress (uint32_t interface, Ipv4InterfaceAddress address)
{
...
void 
Ipv4GlobalRoutingMulticast::NotifyRemoveAddress (uint32_t interface, Ipv4InterfaceAddress address)
{
  NS_LOG_FUNCTION (this << interface << address);
  if (m_respondToInterfaceEvents && Simulator::Now ().GetSeconds () > 0)  // avoid startup events
    {
...
void 
Ipv4GlobalRoutingMulticast::SetIpv4 (Ptr<Ipv4Multicast> ipv4)
{
