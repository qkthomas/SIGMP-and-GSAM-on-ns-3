...
#include "ns3/node.h"
#include "ns3/ipv4-static-routing-multicast.h"
#include "ipv4-list-routing-multicast.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("Ipv4ListRoutingMulticast");

NS_OBJECT_ENSURE_REGISTERED (Ipv4ListRoutingMulticast);

TypeId
Ipv4ListRoutingMulticast::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::Ipv4ListRoutingMulticast")
    .SetParent<Ipv4RoutingProtocolMulticast> ()
    .SetGroupName ("Internet")
    .AddConstructor<Ipv4ListRoutingMulticast> ()
  ;
  return tid;
}


Ipv4ListRoutingMulticast::Ipv4ListRoutingMulticast () 
  : m_ipv4 (0)
{
...
void
Ipv4ListRoutingMulticast::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4ListRoutingMulticast::PrintRoutingTable (Ptr<OutputStreamWrapper> stream) const
{
  NS_LOG_FUNCTION (this << stream);
  *stream->GetStream () << "Node: " << m_ipv4->GetObject<Node> ()->GetId () 
                        << ", Time: " << Now().As (Time::S)
                        << ", Local time: " << GetObject<Node> ()->GetLocalTime ().As (Time::S)
                        << ", Ipv4ListRoutingMulticast table" << std::endl;
...
void
Ipv4ListRoutingMulticast::DoInitialize (void)
{
  NS_LOG_FUNCTION (this);
  for (Ipv4RoutingProtocolList::iterator rprotoIter = m_routingProtocols.begin ();
       rprotoIter != m_routingProtocols.end (); rprotoIter++)
    {
      Ptr<Ipv4RoutingProtocolMulticast> protocol = (*rprotoIter).second;
      protocol->Initialize ();
    }
  Ipv4RoutingProtocolMulticast::DoInitialize ();
}


Ptr<Ipv4Route>
Ipv4ListRoutingMulticast::RouteOutput (Ptr<Packet> p, const Ipv4Header &header, Ptr<NetDevice> oif, enum Socket::SocketErrno &sockerr)
{
...
bool 
Ipv4ListRoutingMulticast::RouteInput (Ptr<const Packet> p, const Ipv4Header &header, Ptr<const NetDevice> idev, 
...
void 
Ipv4ListRoutingMulticast::NotifyInterfaceUp (uint32_t interface)
{
...
void 
Ipv4ListRoutingMulticast::NotifyInterfaceDown (uint32_t interface)
{
  NS_LOG_FUNCTION (this << interface);
  for (Ipv4RoutingProtocolList::const_iterator rprotoIter =
         m_routingProtocols.begin ();
...
void 
Ipv4ListRoutingMulticast::NotifyAddAddress (uint32_t interface, Ipv4InterfaceAddress address)
{
...
void 
Ipv4ListRoutingMulticast::NotifyRemoveAddress (uint32_t interface, Ipv4InterfaceAddress address)
{
  NS_LOG_FUNCTION (this << interface << address);
  for (Ipv4RoutingProtocolList::const_iterator rprotoIter =
         m_routingProtocols.begin ();
...
void 
Ipv4ListRoutingMulticast::SetIpv4 (Ptr<Ipv4Multicast> ipv4)
{
...
void
Ipv4ListRoutingMulticast::AddRoutingProtocol (Ptr<Ipv4RoutingProtocolMulticast> routingProtocol, int16_t priority)
{
...
uint32_t 
Ipv4ListRoutingMulticast::GetNRoutingProtocols (void) const
{
  NS_LOG_FUNCTION (this);
...
Ipv4ListRoutingMulticast::GetRoutingProtocol (uint32_t index, int16_t& priority) const
{
  NS_LOG_FUNCTION (this << index << priority);
  if (index > m_routingProtocols.size ())
    {
      NS_FATAL_ERROR ("Ipv4ListRoutingMulticast::GetRoutingProtocol():  index " << index << " out of range");
    }
  uint32_t i = 0;
...
bool 
Ipv4ListRoutingMulticast::Compare (const Ipv4RoutingProtocolEntry& a, const Ipv4RoutingProtocolEntry& b)
{
