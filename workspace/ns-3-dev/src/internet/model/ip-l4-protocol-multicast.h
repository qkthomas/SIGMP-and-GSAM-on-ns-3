...
#ifndef IP_L4_PROTOCOL_MULTICAST_H
#define IP_L4_PROTOCOL_MULTICAST_H
 ...
 * the network layer.
 */
class IpL4ProtocolMulticast : public Object
{
public:
  /**
   ...
   * \param incomingInterface the Ipv4InterfaceMulticast on which the packet arrived
   * \returns Rx status code
   */
  virtual enum RxStatus Receive (Ptr<Packet> p,
                                 Ipv4Header const &header,
                                 Ptr<Ipv4InterfaceMulticast> incomingInterface) = 0;
