...
#ifndef IPV4_END_POINT_DEMUX_H_MULTICAST
#define IPV4_END_POINT_DEMUX_H_MULTICAST
 ...
 * about a four-tuple to an ns3::Ipv4EndPointMulticast.  It internally contains a list
...
public:
   ...
   */
  typedef std::list<Ipv4EndPointMulticast *> EndPoints;
   ...
   * \return list of Ipv4EndPointMulticast
   */
   ...
   */
  Ipv4EndPointMulticast *SimpleLookup (Ipv4Address daddr, 
                              uint16_t dport, 
                              Ipv4Address saddr, 
                              uint16_t sport);

  /**
   * \brief Allocate a Ipv4EndPointMulticast.
   * \return an empty Ipv4EndPointMulticast instance
   */
   ...
   * \return an Ipv4EndPointMulticast instance
   */
   ...
   * \return an Ipv4EndPointMulticast instance
   */
  Ipv4EndPointMulticast *Allocate (Ipv4Address localAddress, 
                          uint16_t localPort,
...
#endif /* IPV4_END_POINT_DEMUX_H_MULTICAST */
