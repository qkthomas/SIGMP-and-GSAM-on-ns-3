...
#include "ipv4-global-routing-multicast.h"
#include "global-router-interface-multicast.h"
#include <vector>

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("GlobalRouterMulticast");

// ---------------------------------------------------------------------------
//
// GlobalRoutingLinkRecordMulticast Implementation
//
// ---------------------------------------------------------------------------

GlobalRoutingLinkRecordMulticast::GlobalRoutingLinkRecordMulticast ()
  :
    m_linkId ("0.0.0.0"),
    m_linkData ("0.0.0.0"),
    m_linkType (Unknown),
...
Ipv4Address
GlobalRoutingLinkRecordMulticast::GetLinkId (void) const
{
  NS_LOG_FUNCTION (this);
  return m_linkId;
}
...
void
GlobalRoutingLinkRecordMulticast::SetLinkId (Ipv4Address addr)
{
...
Ipv4Address
GlobalRoutingLinkRecordMulticast::GetLinkData (void) const
{
  NS_LOG_FUNCTION (this);
  return m_linkData;
}
...
void
GlobalRoutingLinkRecordMulticast::SetLinkData (Ipv4Address addr)
{
  NS_LOG_FUNCTION (this << addr);
  m_linkData = addr;
}

GlobalRoutingLinkRecordMulticast::LinkType
GlobalRoutingLinkRecordMulticast::GetLinkType (void) const
{
  NS_LOG_FUNCTION (this);
  return m_linkType;
}
...
void
GlobalRoutingLinkRecordMulticast::SetLinkType (
  GlobalRoutingLinkRecordMulticast::LinkType linkType)
{
...
uint16_t
GlobalRoutingLinkRecordMulticast::GetMetric (void) const
{
  NS_LOG_FUNCTION (this);
  return m_metric;
}
...
void
GlobalRoutingLinkRecordMulticast::SetMetric (uint16_t metric)
{
...
// ---------------------------------------------------------------------------
//
// GlobalRoutingLSAMulticast Implementation
//
// ---------------------------------------------------------------------------

GlobalRoutingLSAMulticast::GlobalRoutingLSAMulticast()
  : 
    m_lsType (GlobalRoutingLSAMulticast::Unknown),
    m_linkStateId ("0.0.0.0"),
    m_advertisingRtr ("0.0.0.0"),
    m_linkRecords (),
    m_networkLSANetworkMask ("0.0.0.0"),
    m_attachedRouters (),
    m_status (GlobalRoutingLSAMulticast::LSA_SPF_NOT_EXPLORED),
    m_node_id (0)
{
  NS_LOG_FUNCTION (this);
}
...
GlobalRoutingLSAMulticast::GlobalRoutingLSAMulticast (
  GlobalRoutingLSAMulticast::SPFStatus status,
...
GlobalRoutingLSAMulticast::GlobalRoutingLSAMulticast (GlobalRoutingLSAMulticast& lsa)
    ...
    m_node_id (lsa.m_node_id)
{
  ...
  NS_ASSERT_MSG (IsEmpty (),
                 "GlobalRoutingLSAMulticast::GlobalRoutingLSAMulticast (): Non-empty LSA in constructor");
  CopyLinkRecords (lsa);
}

GlobalRoutingLSAMulticast&
GlobalRoutingLSAMulticast::operator= (const GlobalRoutingLSAMulticast& lsa)
{
  NS_LOG_FUNCTION (this << &lsa);
...
void
GlobalRoutingLSAMulticast::CopyLinkRecords (const GlobalRoutingLSAMulticast& lsa)
{
  NS_LOG_FUNCTION (this << &lsa);
  for (ListOfLinkRecords_t::const_iterator i = lsa.m_linkRecords.begin ();
       ...
       i++)
    {
      GlobalRoutingLinkRecordMulticast *pSrc = *i;
      GlobalRoutingLinkRecordMulticast *pDst = new GlobalRoutingLinkRecordMulticast;
...
void
GlobalRoutingLSAMulticast::ClearLinkRecords (void)
{
  NS_LOG_FUNCTION (this);
  for ( ListOfLinkRecords_t::iterator i = m_linkRecords.begin ();
        ...
        i++)
    {
      ...
      GlobalRoutingLinkRecordMulticast *p = *i;
      delete p;
      p = 0;
...
uint32_t
GlobalRoutingLSAMulticast::AddLinkRecord (GlobalRoutingLinkRecordMulticast* lr)
{
...
uint32_t
GlobalRoutingLSAMulticast::GetNLinkRecords (void) const
{
  NS_LOG_FUNCTION (this);
  return m_linkRecords.size ();
}

GlobalRoutingLinkRecordMulticast *
GlobalRoutingLSAMulticast::GetLinkRecord (uint32_t n) const
{
  ...
  NS_ASSERT_MSG (false, "GlobalRoutingLSAMulticast::GetLinkRecord (): invalid index");
  return 0;
}

bool
GlobalRoutingLSAMulticast::IsEmpty (void) const
{
  NS_LOG_FUNCTION (this);
  return m_linkRecords.size () == 0;
}

GlobalRoutingLSAMulticast::LSType
GlobalRoutingLSAMulticast::GetLSType (void) const
{
  NS_LOG_FUNCTION (this);
  return m_lsType;
}
...
void
GlobalRoutingLSAMulticast::SetLSType (GlobalRoutingLSAMulticast::LSType typ) 
{
...
Ipv4Address
GlobalRoutingLSAMulticast::GetLinkStateId (void) const
{
  NS_LOG_FUNCTION (this);
...
void
GlobalRoutingLSAMulticast::SetLinkStateId (Ipv4Address addr)
{
  NS_LOG_FUNCTION (this << addr);
  m_linkStateId = addr;
}
...
Ipv4Address
GlobalRoutingLSAMulticast::GetAdvertisingRouter (void) const
{
  NS_LOG_FUNCTION (this);
...
void
GlobalRoutingLSAMulticast::SetAdvertisingRouter (Ipv4Address addr)
{
  NS_LOG_FUNCTION (this << addr);
...
void
GlobalRoutingLSAMulticast::SetNetworkLSANetworkMask (Ipv4Mask mask)
{
...
Ipv4Mask
GlobalRoutingLSAMulticast::GetNetworkLSANetworkMask (void) const
{
  NS_LOG_FUNCTION (this);
  return m_networkLSANetworkMask;
}

GlobalRoutingLSAMulticast::SPFStatus
GlobalRoutingLSAMulticast::GetStatus (void) const
{
  NS_LOG_FUNCTION (this);
  return m_status;
}
...
uint32_t
GlobalRoutingLSAMulticast::AddAttachedRouter (Ipv4Address addr)
{
  NS_LOG_FUNCTION (this << addr);
...
uint32_t
GlobalRoutingLSAMulticast::GetNAttachedRouters (void) const
{
  NS_LOG_FUNCTION (this);
  return m_attachedRouters.size (); 
}
...
Ipv4Address
GlobalRoutingLSAMulticast::GetAttachedRouter (uint32_t n) const
{
  NS_LOG_FUNCTION (this << n);
  uint32_t j = 0;
  ...
  NS_ASSERT_MSG (false, "GlobalRoutingLSAMulticast::GetAttachedRouter (): invalid index");
  return Ipv4Address ("0.0.0.0");
}

void
GlobalRoutingLSAMulticast::SetStatus (GlobalRoutingLSAMulticast::SPFStatus status)
{
...
Ptr<Node>
GlobalRoutingLSAMulticast::GetNode (void) const
{
  NS_LOG_FUNCTION (this);
...
void
GlobalRoutingLSAMulticast::SetNode (Ptr<Node> node)
{
...
void
GlobalRoutingLSAMulticast::Print (std::ostream &os) const
{
  NS_LOG_FUNCTION (this << &os);
  os << std::endl;
  os << "========== Global Routing LSA ==========" << std::endl;
  os << "m_lsType = " << m_lsType;
  if (m_lsType == GlobalRoutingLSAMulticast::RouterLSA) 
    {
      os << " (GlobalRoutingLSAMulticast::RouterLSA)";
    }
  else if (m_lsType == GlobalRoutingLSAMulticast::NetworkLSA) 
    {
      os << " (GlobalRoutingLSAMulticast::NetworkLSA)";
    }
  else if (m_lsType == GlobalRoutingLSAMulticast::ASExternalLSAs)
    {
      os << " (GlobalRoutingLSAMulticast::ASExternalLSA)";
    }
  else
    {
      os << "(Unknown LSType)";
  ...
  if (m_lsType == GlobalRoutingLSAMulticast::RouterLSA) 
    {
      for ( ListOfLinkRecords_t::const_iterator i = m_linkRecords.begin ();
            ...
            i++)
        {
          ...
          if (p->m_linkType == GlobalRoutingLinkRecordMulticast::PointToPoint)
            {
              os << " (GlobalRoutingLinkRecordMulticast::PointToPoint)" << std::endl;
              os << "m_linkId = " << p->m_linkId << std::endl;
              os << "m_linkData = " << p->m_linkData << std::endl;
              os << "m_metric = " << p->m_metric << std::endl;
            }
          else if (p->m_linkType == GlobalRoutingLinkRecordMulticast::TransitNetwork)
            {
              os << " (GlobalRoutingLinkRecordMulticast::TransitNetwork)" << std::endl;
          ...
          else if (p->m_linkType == GlobalRoutingLinkRecordMulticast::StubNetwork)
            {
              os << " (GlobalRoutingLinkRecordMulticast::StubNetwork)" << std::endl;
...
std::ostream& operator<< (std::ostream& os, GlobalRoutingLSAMulticast& lsa)
{
  lsa.Print (os);
  return os;
}
...
// ---------------------------------------------------------------------------
//
// GlobalRouterMulticast Implementation
//
// ---------------------------------------------------------------------------

NS_OBJECT_ENSURE_REGISTERED (GlobalRouterMulticast);

TypeId 
GlobalRouterMulticast::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::GlobalRouterMulticast")
    .SetParent<Object> ()
    .SetGroupName ("Internet");
  return tid;
}

GlobalRouterMulticast::GlobalRouterMulticast ()
  : m_LSAs ()
{
  NS_LOG_FUNCTION (this);
  m_routerId.Set (GlobalRouteManagerMulticast::AllocateRouterId ());
}
...
void 
GlobalRouterMulticast::SetRoutingProtocol (Ptr<Ipv4GlobalRoutingMulticast> routing)
{
  NS_LOG_FUNCTION (this << routing);
  m_routingProtocol = routing;
}
Ptr<Ipv4GlobalRoutingMulticast> 
GlobalRouterMulticast::GetRoutingProtocol (void)
{
  NS_LOG_FUNCTION (this);
...
void
GlobalRouterMulticast::DoDispose ()
{
  NS_LOG_FUNCTION (this);
  m_routingProtocol = 0;
...
void
GlobalRouterMulticast::ClearLSAs ()
{
  NS_LOG_FUNCTION (this);
...
Ipv4Address
GlobalRouterMulticast::GetRouterId (void) const
{
  NS_LOG_FUNCTION (this);
  return m_routerId;
}
...
//
// DiscoverLSAs is called on all nodes in the system that have a GlobalRouterMulticast
...
// 
uint32_t 
GlobalRouterMulticast::DiscoverLSAs ()
{
  NS_LOG_FUNCTION (this);
  Ptr<Node> node = GetObject<Node> ();
  NS_ABORT_MSG_UNLESS (node, "GlobalRouterMulticast::DiscoverLSAs (): GetObject for <Node> interface failed");
  ...
  // Ipv4Multicast interface.  This is where the information regarding the attached 
  // interfaces lives.  If we're a router, we had better have an Ipv4Multicast interface.
  //
  Ptr<Ipv4Multicast> ipv4Local = node->GetObject<Ipv4Multicast> ();
  NS_ABORT_MSG_UNLESS (ipv4Local, "GlobalRouterMulticast::DiscoverLSAs (): GetObject for <Ipv4Multicast> interface failed");

  //
  // Every router node originates a Router-LSA
  //
  GlobalRoutingLSAMulticast *pLSA = new GlobalRoutingLSAMulticast;
  pLSA->SetLSType (GlobalRoutingLSAMulticast::RouterLSA);
  pLSA->SetLinkStateId (m_routerId);
  pLSA->SetAdvertisingRouter (m_routerId);
  pLSA->SetStatus (GlobalRoutingLSAMulticast::LSA_SPF_NOT_EXPLORED);
  pLSA->SetNode (node);
  ...
  for (uint32_t i = 0; i < numDevices; ++i)
    {
      ...
      if (NetDeviceIsBridged (ndLocal))
        {
          ...
          NS_ABORT_MSG_IF (rc, "GlobalRouterMulticast::DiscoverLSAs(): Bridge ports must not have an IPv4 interface index");
        }
      ...
      if (ndLocal->IsBroadcast () && !ndLocal->IsPointToPoint () )
        ...
        {
          NS_ASSERT_MSG (0, "GlobalRouterMulticast::DiscoverLSAs (): unknown link type");
        }
    }
  ...
  for (InjectedRoutesCI i = m_injectedRoutes.begin ();
    ...
    {
      GlobalRoutingLSAMulticast *pLSA = new GlobalRoutingLSAMulticast;
      pLSA->SetLSType (GlobalRoutingLSAMulticast::ASExternalLSAs);
...
void
GlobalRouterMulticast::ProcessBroadcastLink (Ptr<NetDevice> nd, GlobalRoutingLSAMulticast *pLSA, NetDeviceContainer &c)
{
...
void
GlobalRouterMulticast::ProcessSingleBroadcastLink (Ptr<NetDevice> nd, GlobalRoutingLSAMulticast *pLSA, NetDeviceContainer &c)
{
  NS_LOG_FUNCTION (this << nd << pLSA << &c);

  GlobalRoutingLinkRecordMulticast *plr = new GlobalRoutingLinkRecordMulticast;
  NS_ABORT_MSG_IF (plr == 0, "GlobalRouterMulticast::ProcessSingleBroadcastLink(): Can't alloc link record");
  ...
  Ptr<Ipv4Multicast> ipv4Local = node->GetObject<Ipv4Multicast> ();
  NS_ABORT_MSG_UNLESS (ipv4Local, "GlobalRouterMulticast::ProcessSingleBroadcastLink (): GetObject for <Ipv4Multicast> interface failed");

  // Initialize to value out of bounds to silence compiler
  uint32_t interfaceLocal = ipv4Local->GetNInterfaces () + 1;
  bool rc = FindInterfaceForDevice (node, nd, interfaceLocal);
  NS_ABORT_MSG_IF (rc == false, "GlobalRouterMulticast::ProcessSingleBroadcastLink(): No interface index associated with device");
  ...
  if (AnotherRouterOnLink (nd, true) == false)
    {
      ...
      plr->SetLinkType (GlobalRoutingLinkRecordMulticast::StubNetwork);
  ...
  else
    {
      ...
      plr->SetLinkType (GlobalRoutingLinkRecordMulticast::TransitNetwork);
      ...
      if (desigRtr != "255.255.255.255")
        {
          ...
          NS_ABORT_MSG_UNLESS (networkHere == networkThere, 
                               "GlobalRouterMulticast::ProcessSingleBroadcastLink(): Network number confusion");
        }
...
void
GlobalRouterMulticast::ProcessBridgedBroadcastLink (Ptr<NetDevice> nd, GlobalRoutingLSAMulticast *pLSA, NetDeviceContainer &c)
{
  NS_LOG_FUNCTION (this << nd << pLSA << &c);
  NS_ASSERT_MSG (nd->IsBridge (), "GlobalRouterMulticast::ProcessBridgedBroadcastLink(): Called with non-bridge net device");
  ...
  NS_ABORT_MSG_UNLESS (bnd, "GlobalRouterMulticast::DiscoverLSAs (): GetObject for <BridgeNetDevice> failed");
  ...
  Ptr<Node> node = nd->GetNode ();
  Ptr<Ipv4Multicast> ipv4Local = node->GetObject<Ipv4Multicast> ();
  NS_ABORT_MSG_UNLESS (ipv4Local, "GlobalRouterMulticast::ProcessBridgedBroadcastLink (): GetObject for <Ipv4Multicast> interface failed");

  // Initialize to value out of bounds to silence compiler
  uint32_t interfaceLocal = ipv4Local->GetNInterfaces () + 1;
  bool rc = FindInterfaceForDevice (node, nd, interfaceLocal);
  NS_ABORT_MSG_IF (rc == false, "GlobalRouterMulticast::ProcessBridgedBroadcastLink(): No interface index associated with device");
  ...
  // given a net device that is a BridgeNetDevice.  It has an associated Ipv4Multicast
  ...
  GlobalRoutingLinkRecordMulticast *plr = new GlobalRoutingLinkRecordMulticast;
  NS_ABORT_MSG_IF (plr == 0, "GlobalRouterMulticast::ProcessBridgedBroadcastLink(): Can't alloc link record");
...
void
GlobalRouterMulticast::ProcessPointToPointLink (Ptr<NetDevice> ndLocal, GlobalRoutingLSAMulticast *pLSA)
{
  ...
  Ptr<Ipv4Multicast> ipv4Local = nodeLocal->GetObject<Ipv4Multicast> ();
  NS_ABORT_MSG_UNLESS (ipv4Local, "GlobalRouterMulticast::ProcessPointToPointLink (): GetObject for <Ipv4Multicast> interface failed");

  uint32_t interfaceLocal = ipv4Local->GetNInterfaces () + 1;
  bool rc = FindInterfaceForDevice (nodeLocal, ndLocal, interfaceLocal);
  NS_ABORT_MSG_IF (rc == false, "GlobalRouterMulticast::ProcessPointToPointLink (): No interface index associated with device");
  ...
  // device for its node, then ask that node for its Ipv4Multicast interface.  Note a
  ...
  Ptr<Ipv4Multicast> ipv4Remote = nodeRemote->GetObject<Ipv4Multicast> ();
  NS_ABORT_MSG_UNLESS (ipv4Remote, 
                       "GlobalRouterMulticast::ProcessPointToPointLink(): GetObject for remote <Ipv4Multicast> failed");

  //
  // Further note the requirement that nodes on either side of a point-to-point 
  // link must participate in global routing and therefore have a GlobalRouterMulticast
  // interface aggregated.
  //
  Ptr<GlobalRouterMulticast> rtrRemote = nodeRemote->GetObject<GlobalRouterMulticast> ();
  if (rtrRemote == 0)
    {
  ...
  NS_ABORT_MSG_IF (rc == false, "GlobalRouterMulticast::ProcessPointToPointLinks(): No interface index associated with remote device");

  //
  // Now that we have the Ipv4Multicast interface, we can get the (remote) address and
  // mask we need.
  //
  ...
  //
  GlobalRoutingLinkRecordMulticast *plr;
  if (ipv4Remote->IsUp (interfaceRemote))
    {
      NS_LOG_LOGIC ("Remote side interface " << interfaceRemote << " is up-- add a type 1 link");
 
      plr  = new GlobalRoutingLinkRecordMulticast;
      NS_ABORT_MSG_IF (plr == 0, "GlobalRouterMulticast::ProcessPointToPointLink(): Can't alloc link record");
      plr->SetLinkType (GlobalRoutingLinkRecordMulticast::PointToPoint);
...
void
GlobalRouterMulticast::BuildNetworkLSAs (NetDeviceContainer c)
{
  ...
  for (uint32_t i = 0; i < nDesignatedRouters; ++i)
    {
      ...
      NS_ABORT_MSG_IF (rc == false, "GlobalRouterMulticast::BuildNetworkLSAs (): No interface index associated with device");
      ...
      GlobalRoutingLSAMulticast *pLSA = new GlobalRoutingLSAMulticast;
      NS_ABORT_MSG_IF (pLSA == 0, "GlobalRouterMulticast::BuildNetworkLSAs(): Can't alloc link record");

      pLSA->SetLSType (GlobalRoutingLSAMulticast::NetworkLSA);
      ...
      // and, if we find a node with a GlobalRouterMulticast interface and an IPv4 
      ...
      for (uint32_t i = 0; i < nDevices; i++)
        {
          ...
          //
          // Does the node in question have a GlobalRouterMulticast interface?  If not it can
          // hardly be considered an attached router.
          //
          Ptr<GlobalRouterMulticast> rtr = tempNode->GetObject<GlobalRouterMulticast> ();
          if (rtr == 0)
            { 
              continue;
            }
          ...
          if (FindInterfaceForDevice (tempNode, tempNd, tempInterface))
            {
              Ptr<Ipv4Multicast> tempIpv4 = tempNode->GetObject<Ipv4Multicast> ();
              NS_ASSERT (tempIpv4);
...
// attached and look for nodes with GlobalRouterMulticast interfaces on them (one of them 
...
//
Ipv4Address
GlobalRouterMulticast::FindDesignatedRouterForLink (Ptr<NetDevice> ndLocal, bool allowRecursion) const
{
      ...
      if (bnd)
        {
          ...
          //
          // We require a designated router to have a GlobalRouterMulticast interface and
          // an internet stack that includes the Ipv4Multicast interface.  If it doesn't
          // it can't play router.
          //
          NS_LOG_LOGIC ("Checking for router on bridge net device " << bnd);
          Ptr<GlobalRouterMulticast> rtr = nodeOther->GetObject<GlobalRouterMulticast> ();
          Ptr<Ipv4Multicast> ipv4 = nodeOther->GetObject<Ipv4Multicast> ();
          if (rtr && ipv4)
            {
              // Initialize to value out of bounds to silence compiler
...
// that has a GlobalRouterMulticast interface aggregated.  Life gets more complicated
// when there is a bridged net device on the other side.
//
bool
GlobalRouterMulticast::AnotherRouterOnLink (Ptr<NetDevice> nd, bool allowRecursion) const
{
  ...
  for (uint32_t i = 0; i < nDevices; i++)
    {
      ...
      Ptr<GlobalRouterMulticast> rtr = nodeTemp->GetObject<GlobalRouterMulticast> ();
      if (rtr)
        {
          NS_LOG_LOGIC ("Found GlobalRouterMulticast interface, return true");
          return true;
        }
      else 
        {
          NS_LOG_LOGIC ("No GlobalRouterMulticast interface on device, continue search");
        }
    }
...
uint32_t
GlobalRouterMulticast::GetNumLSAs (void) const
{
  NS_LOG_FUNCTION (this);
  return m_LSAs.size ();
}
...
//
bool
GlobalRouterMulticast::GetLSA (uint32_t n, GlobalRoutingLSAMulticast &lsa) const
{
  NS_LOG_FUNCTION (this << n << &lsa);
  NS_ASSERT_MSG (lsa.IsEmpty (), "GlobalRouterMulticast::GetLSA (): Must pass empty LSA");
//
...
void
GlobalRouterMulticast::InjectRoute (Ipv4Address network, Ipv4Mask networkMask)
{
...
GlobalRouterMulticast::GetInjectedRoute (uint32_t index)
{
...
uint32_t
GlobalRouterMulticast::GetNInjectedRoutes ()
{
  NS_LOG_FUNCTION (this);
...
void
GlobalRouterMulticast::RemoveInjectedRoute (uint32_t index)
{
  NS_LOG_FUNCTION (this << index);
...
bool
GlobalRouterMulticast::WithdrawRoute (Ipv4Address network, Ipv4Mask networkMask)
{
  NS_LOG_FUNCTION (this << network << networkMask);
  for (InjectedRoutesI i = m_injectedRoutes.begin (); i != m_injectedRoutes.end (); i++)
    {
...
//
Ptr<NetDevice>
GlobalRouterMulticast::GetAdjacent (Ptr<NetDevice> nd, Ptr<Channel> ch) const
{
  NS_LOG_FUNCTION (this << nd << ch);
  NS_ASSERT_MSG (ch->GetNDevices () == 2, "GlobalRouterMulticast::GetAdjacent (): Channel with other than two devices");
//
...
//
  if (nd1 == nd)
    ...
    {
      NS_ASSERT_MSG (false,
                     "GlobalRouterMulticast::GetAdjacent (): Wrong or confused channel?");
      return 0;
    }
}
...
//
bool
GlobalRouterMulticast::FindInterfaceForDevice (Ptr<Node> node, Ptr<NetDevice> nd, uint32_t &index) const
{
  ...
  if (ipv4 == 0)
    {
      NS_LOG_LOGIC ("No Ipv4Multicast interface on node " << node->GetId ());
      return false;
    }
...
//
Ptr<BridgeNetDevice>
GlobalRouterMulticast::NetDeviceIsBridged (Ptr<NetDevice> nd) const
{
